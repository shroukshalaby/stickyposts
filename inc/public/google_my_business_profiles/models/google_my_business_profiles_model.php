<?php
class google_my_business_profiles_model extends MY_Model {
	...
	public function block_accounts($path = ""){
		...
		$team_id = _t('id');
		$result = $this->main_model->fetch('*', $this->tb_account_manager, "social_network = 'google_my_business' AND category = 'profile' AND team_id = '".$team_id."'");
		return [
			'position' => 800,
			'id' => $this->module_id,
			...
			'button' => Modules::run("account_manager/block_add", [
				...
				"text" => __("Add Google My Business profile"),
