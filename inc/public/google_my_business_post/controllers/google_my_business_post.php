<?php
class google_my_business_post extends MY_Controller {
	...
	public function index($page = "", $ids = "")
	{
		...
		$block_accounts = Modules::run("post/block_accounts", "google_my_business");
		...
		$views = [
			...
			"column_two" => view("pages/general", [ 'file_manager_photo' => $block_file_photo, 'block_post_type' => $block_post_type, 'block_caption' => $block_caption, 'block_schedule' => $block_schedule ] ,true), 
