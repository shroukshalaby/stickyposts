...
@section('body')
    ...
    <section class="pricing-style-one home-page-two remove-bg" id="pricing" style="background:linear-gradient(90deg, #320b82 0%, #9c33c3 100%)!important;padding:20px 0 20px;">
        <div class="container-fluid">
                ...
                <ul class="nav nav-tabs tab-title m-0 " role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" href="#annual" role="tab" data-toggle="tab">{{ __('pay-Yearly')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="#monthly" role="tab" data-toggle="tab">{{ __('fam-Monthly')}} </a>
                    </li>
                </ul>
                        ...
                        <div class="col-lg-11 mx-auto">
                                ...
                                <div class="single-pricing-one">
                                    <div class="top-block" style="direction: ltr;">
                                        <h2>{{ __('pay-Economical')}} </h2>
                                         <p class="price m-0" style="direction: rtl;">  @switch($ipData['geoplugin_countryName'])
                                            @case ('Egypt')
                                            99 EGP
                                            @break;
                                    ...
                                    <ul class="feature-lists text-left">
                                        <li><span style="color:#f00">*</span>{{ __('pay-weManage')}} <span style="font-weight:bold;font-size:16px">7</span></li>
                                        <li><span style="color:#f00">*</span>{{ __('pay-UnlimitedMembers')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Posts Generator')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('pay-megabyteStorage')}}</li>
                                    ...
                                    <div class="bottom-block">
                                        <a href="learn-moreen.php">{{ __('fam-learnMore')}}</a>
                                        ...
                                        <h5 class="tag-line text-center">{!! __('fam-No Extra')!!}</h5>
                             <p>{{ __('pay-threeDaysFree')}}</p>
                                    </div><!-- /.bottom-block -->
                                    ...
                                    <ul class="feature-lists text-left">
                                        <li><span style="color:#f00">*</span>{{ __('pay-weManage')}} <span style="font-weight:bold;font-size:16px">14</span></li>
                                        ...
                                        <li><span style="color:#f00">*</span>{{ __('fam-Reports')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Auto Activities')}} <span style="padding:5px;color:#f00">{{ __('fam-extra')}} </span></li>
                                        <li><span style="color:#f00">*</span>{{ __('pay-multipleAccounts')}}  <span style="padding:5px;color:#f00">{{ __('fam-extra')}} </span></li>
                                    </ul><!-- /.feature-lists text-left -->
                                    <div class="bottom-block">
                                        <a href="learn-moreen.php">{{ __('fam-learnMore')}}</a>
                                        <a href="https://stickyposts.net/stickypost_register/register-en.php?language=2" class="price-btn" style="cursor: pointer;">{{ __('fam-Buy Now')}}</a>
                                ...
                                <div class="single-pricing-one">
                                    ...
                                    <ul class="feature-lists text-left">
                                        <li><span style="color:#f00">*</span>{{ __('fam-You can manage')}}<span style="font-weight:bold;font-size:16px"> 35 </span>{{ __('fam-pages only')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('fam-Unlimited team members')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('pay-DesignPosts')}} </li>
                                            <li><span style="color:#f00">*</span>{{ __('fam-Up to 50 Megabyte available storage')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('fam-Copyright protection')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('fam-Reports')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('fam-Auto Activities')}} </li>
                                ...
                                <div class="single-pricing-one">
                                    ...
                                    <ul class="feature-lists text-left">
                                            ...
                                            <li><span style="color:#f00">*</span>{{ __('fam-You can manage')}} <span style="font-weight:bold;font-size:16px"> 70 </span> {{ __('fam-pages only')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('fam-Unlimited team members')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('pay-DesignPosts')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('fam-Up to 50 Megabyte available storage')}}</li>
                                            <li><span style="color:#f00">*</span>{{ __('fam-Copyright protection')}}</li>
                                    ...
                                    <div class="bottom-block">
                                        <a href="https://stickyposts.net/sticky/landing_page_new_en.php">{{ __('fam-learnMore')}}</a>
                                        <a href="https://stickyposts.net/stickypost_register/register-en.php?language=2" class="price-btn" style="cursor: pointer;">{{ __('fam-Buy Now')}}</a>
                                        <h5 class="tag-line text-center" style="color:#310150;background: #eee;padding: 6px;margin: 0;">{!! __('fam-No Extra')!!}</h5>
                                        <p>{{ __('pay-threeDaysFree')}}</p>     
                                    ...
                                    <div class="col-lg-2 p-1 col-md-4 mt-sm-2 col-sm-6 col-12">
                                      <div class="single-pricing-one m-auto" style="width:100%; height: 100%;background: linear-gradient(180deg , #3AB4E7 , #223976 );color: #fff;">
                                         <div class="top-block">
                                        <h2>{{ __('pay-Enterprise')}}</h2>
                                        <p style="margin:0;font-size: 22px;"> {{ __('pay-specialServices')}} </p>
                                        <div class="line"></div><!-- /.line -->
                                    </div><!-- /.top-block -->
                                    
                                    <div class="">
                                        <h6 style=""> {{ __('pay-specialSolution')}} </h6> 
    
                                    </div>
                                    <div class="bottom-blocks" style="position: absolute;">
                                        <a href="https://stickyposts.net/sticky/contact-sel.php" class="price-btn" style="cursor: pointer;margin-bottom: 2.8rem;">{{ __('fam-Buy Now')}}</a> 
                                            
                                        <p style="color: #f00;font-weight: bold;margin:0 auto;padding:0 5px;border-top: 2px solid #999;width: 100%;margin-top: 0;margin-bottom: 0;background:#fff;font-size:18px">{{ __('pay-threeDaysFree')}}</p>                                    </div>
                                </div><!-- /.single-pricing-one -->
                            </div>
                                </div>
                          </div>  
                            ...
                            <div class='row m-auto p-0 justify-content-center'>
                                    ...
                                    <div class="col-lg-2 p-1 col-md-4 col-sm-6 col-12 mt-sm-2">
                                     <div class="single-pricing-one">
                                      ...
                                      <ul class="feature-lists text-left">
                                        <li><span style="color:#f00">*</span>{{ __('fam-You can manage')}} <span style="font-weight:bold;font-size:16px">7</span></li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Unlimited team members')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Posts Generator')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Up to 50 Megabyte available storage')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Copyright protection')}}</li>
                                    ...
                                    <ul class="feature-lists text-left">
                                        <li><span style="color:#f00">*</span>{{ __('fam-You can manage')}} <span style="font-weight:bold;font-size:16px">14</span></li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Unlimited team members')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Posts Generator')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Up to 50 Megabyte available storage')}} </li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Copyright protection')}}  </li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Reports')}}</li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-Auto Activities')}}<span style="padding:5px;color:#f00">{{ __('fam-extra')}} </span></li>
                                        <li><span style="color:#f00">*</span>{{ __('fam-multipleAccounts')}}  <span style="padding:5px;color:#f00">{{ __('fam-extra')}} </span></li>
                                    </ul><!-- /.feature-lists text-left -->
                                    <div class="bottom-block">
                                        <a href="learn-moreen.php">{{ __('fam-learnMore')}}</a>
                                        <a href="https://stickyposts.net/stickypost_register/register-en.php?language=2" class="price-btn" style="cursor: pointer;">{{ __('fam-Buy Now')}}</a>
  ...
  <div class="modal-dialog miniDialog" role="document">
    <div class="modal-content" style="background: linear-gradient(275deg, #5e2298, #320b82);color:#fff">
      ...
      <div id="modal-bodyres" class="text-center" style="margin: 10px 0;">
            <h3 style=' color:#fff' class='text-center'> {{ __('temp-h3')}}  <span style="color:#f9c412; font-weight:bold" >{{ __('temp-h3Free')}} </span></h3>
            <div class="row my-row m-0 px-2">
              <div class="col-sm-7">
                  <div class="page-links nav nav-pills mb-4" id="pills-tab" role="tablist">
                            <a id="pills-home2-tab" data-toggle="pill" href="#pills-home2" role="tab" aria-controls="pills-home2" aria-selected="true" class="ml-auto mr-3 model-tabs active">{{ __('temp-login')}}</a>
                            
                            <a id="pills-profile2-tab" data-toggle="pill" href="#pills-profile2" role="tab" aria-controls="pills-profile2" aria-selected="false" class='mr-3 model-tabs ' >{{ __('temp-register')}}</a>
                        </div>
             ...
             <form style="direction:ltr" class="form-company" method= "post" >
                ...
                <div class="form-group row mb-1 ml-auto" style="align-items: center;" >
                    <label class="col-4 p-0" style="margin: 0;font-size: 12px;">  <span style="color:red">*</span>{{ __('temp-email')}}</label>
                    <div class="col-8">
                        <input type="email" class="form-control" name="mail"  style="height: 24px;" required>
                    </div>
                </div>
                <div class="form-group row mb-1 ml-auto" style="align-items: center;" >
                    <label class="col-4 p-0" style="margin: 0;font-size: 12px;">  <span style="color:red">*</span>{{ __('temp-password')}}</label>
                    <div class="col-8">
                ...
                <div class="form-group row mb-1 mx-0" style="align-items:center;justify-content:center">
                    <div class="col-12 px-4">
                        <a href="https://stickyposts.net/sticky/forget.php?lang=en" style="color: #fff;text-decoration: underline;">{{ __('temp-forgetPassword')}}</a>
                    </div>
                </div>
               <div class="form-group mb-0  row  mt-3 text-center" style='display: flex;justify-content: center;align-items: center; flex-direction: column;'>
                    <button class="submit mb-0 ml-0" type="submit" name="login" style='height: 35px;border-radius: 5px; font-size: 1.5rem;font-weight: 600;background: #f9c412 !important;color: #320b82;' name="login" id="sub">{{ __('temp-getItNow')}} </button>
                </div>
                </form>
             </div>
             <div class="tab-pane fade" id="pills-profile2" role="tabpanel" aria-labelledby="pills-profile2-tab">
              <form style="direction:ltr" class="form-company" method= "post" >
                ...
                <div class="form-group row mb-1  ml-auto" >
                    <label class="col-4 p-0" style="margin: 0;font-size:12px">  <span style="color:red">*</span>{{ __('temp-firstName')}}</label>
                    <div class="col-8">
                ...
                <div class="form-group row mb-1  ml-auto" style="align-items: center;" >
                    <label class="col-4 p-0" style="margin: 0;font-size:12px">  <span style="color:red">*</span>{{ __('temp-lastName')}}</label>
                    <div class="col-8">
                ...
                <div class="form-group row mb-1 ml-auto" style="align-items: center;" >
                  ...
                  <div class="form-group row mb-1 ml-auto" style="align-items: center;" >
                   ...
                   <div class="form-group row mb-1 ml-auto" style="align-items: center;" >
                    <label class="col-4 p-0" style="margin: 0;font-size: 10px;">  <span style="color:red">*</span>  {{ __('temp-ConfirmPass')}} </label>
                    <div class="col-8">
                ...
                <div class="col-4 p-0" >  
                <label style="margin: 0;font-size: 12px;" for=""><span style="color:red">*</span> {{ __('repo-Country')}}</label>
                </div>
                <div class="col-8 p-0" >
               ...
               <div class="form-group mb-0  row  mt-3 text-center" style='display: flex;justify-content: center;align-items: center; flex-direction: column;'>
                    <button class="submit mb-0 ml-0" type="submit" name="signin" style='height: 35px;border-radius: 5px; font-size: 1.5rem;font-weight: 600;background: #f9c412 !important;color: #320b82;' name="submit" id="sub"> {{ __('temp-getItNow')}} </button>
                </div>
                </form>
        ...
        <div style="display:flex;justify-content: space-between;" >
            <small class='text-left' style="font-size:10px ;margin-left:15px">{{ __('repo-informationSafe')}}</small>
            <small class='text-right' style="font-size:10px ;margin-right:15px"><span style="color:#f00">*</span>{{ __('repo-All fields')}} </small>
        </div>
      </div>
    </div>
  </div>
