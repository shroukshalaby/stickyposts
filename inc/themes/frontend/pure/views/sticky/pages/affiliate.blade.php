...
<section class="{{  getCurrentLangIdiom() == 'ar' ? ' text-right'  : '' }}" id="">
        ...
        <div class="view-mobile carouselControl">
            <div class="container">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <form dir="ltr" method="post" class="reports affiliate_form_login">
                                        ...
                                        <div class="form-group mb-0 row mt-3 text-center d-flex justify-content-center align-items-center flex-column">
                                            <button class="submit mb-0 ml-0 myBackgroundStyleAndHeight" type="submit"
                                ...
                                <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <form dir="ltr" method="post" class="formres affiliate_form_register">
                                        ...
                                        <div class="form-group mb-0  row  mt-3 text-center d-flex justify-content-center align-items-center flex-column">
                                            <button class="submit mb-0 ml-0 AffiliateProgram" type="submit"
