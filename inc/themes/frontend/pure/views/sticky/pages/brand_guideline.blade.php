...
@endsection
@section('body')
  <div class="container my-5 {{  getCurrentLangIdiom() == 'ar' ? ' text-right'  : '' }} ">
            <div class="row">
                <div class="col-md-8 mx-auto p-3">
                    ...
                    <div class="pr-content">
                        <div class="pr-story__body margin-top--large pr-font-color--graphite">
                            <div class="margin-top--large">
                                <div class="margin-top--large">
                                    <h2 class="pr-header--small pr-header--small-mobile pr-font-color--graphite textLeftExternal">{{__('brand-idh21')}}</h2>
                                    <h2 class="pr-header--small pr-header--small-mobile pr-font-color--graphite textLeftExternal">{{__('brand-idh22')}} </h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pr-content">
                        <div class="pr-story__body margin-top--large pr-font-color--graphite"><div class="margin-top--large"><div class="pr-text--normal pr-text--mobile-small">{{__('brand-iddiv13')}}</div></div></div></div>
                    <div class="pr-content">
                    ...
                    <div class="pr-content">
                        <div class="pr-story__body margin-top--large pr-font-color--graphite"><div class="margin-top--large"><div class="pr-header--small">{{__('brand-iddiv14')}}</div></div></div>
                    </div>
                    <div class="pr-content">
                    ...
                    <div class="pr-content mt-4 text-white backgroundColorPadding">
                        <h3 class="contact-h3 text-center marginBottom">  {{__('brand-idh32')}} </h3>
                        <p> {{__('brand-idp1')}}</p>
                        <h3>
                        {{__('brand-idh33')}}
                        </h3>
                        ...
                        <form class="form-redirect brand-guideline">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <label class="margin0"> <span class="text-danger">*</span>{{__('fullname')}}</label>
                                    <input type="text" name="name" class="form-control" required>
                                </div>

                                <div class="col-md-6 col-12">
                                    <label class="margin0"> <span class="text-danger">*</span>{{__('cont-idlab3')}}</label>
                                    <input type="email" name="email" class="form-control" required>
                                </div>
                                <div class="col-md-6 col-12 mb-6">

                                    <label class="margin0"> <span class="text-danger">*</span>{{__('cont-idlab6')}}</label>
                                ...
                                <div class="col-md-6 col-12">
                                    <label class="margin0"> <span class="text-danger">*</span>{{__('cont-idlab4')}}</label>
                                    <input type="text" name="phone" class="form-control" required>

                                </div>

                                <div class="col-md-12 col-12">
                                    <label class="margin0"> <span class="text-danger">*</span>{{__('cont-idlab7')}}</label>
                                    <textarea class="form-control" id="message_contact1" rows="5" name="message" required></textarea>

                                </div>
                                <div class="col-md-12">
                                    <label class="newFontSize"> ( <span class="text-danger">*</span> )  {{__('brand-idlabel1')}}</label>  
                                </div>
                                <div class="col-md-4 mt-5 subscribe_form boxShadow-none">
                                <span class="input-group-btn">
                                    <button class="btn btn-default borderRadious3" type="submit" name=""> {{__('brand-idbtn1')}}</button>
                                </span>
                                </div>
                            </div>
                        </form>
...
@include('sticky.layout.partials.common.sweetalert')
    @include('sticky.layout.partials.common.inboundLeadScript',['selector'=>'.brand-guideline','type'=>'brandGuideLine'])
