    ...
    <div class="row justify-content-center">
                    ...
                    <div class="login-form">
                        <form class="actionLogin" action="<?php _e(get_module_url('ajax_login', $loader)) ?>"
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3"  style="{{  getCurrentLangIdiom() == 'ar' ? 'direction:ltr'  : '' }}">
                            ...
                            <div class="form-group wrap-m mx-0 row">
                                ...
                                <div class="wrap-c p-0 {{  getCurrentLangIdiom() == 'ar' ? 'text-right'  : ' text-left' }}  col-md-6 col-6">
                                ...
                                <div class="wrap-c fs-12 p-0 {{  getCurrentLangIdiom() == 'ar' ? 'text-left'  : ' text-right' }}  col-md-6 col-6">
     ...
     <div class="col-md-6 d-lg-block d-none">
        ...
        <div class="text-center pos-text-abs">
            <h4 class="font-weight-bold text-center text-white lh-15">{{__('reg-h1-text')}}
            {{__('reg-h1-text2')}}</h4>
        </div>
     </div>
    </div>
