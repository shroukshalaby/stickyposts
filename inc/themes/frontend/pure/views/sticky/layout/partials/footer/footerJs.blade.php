<div id="cookies2" style="font-size:.9em;background-color:#444;padding:.7em;text-align:center;display:none;position:fixed;bottom:0;width:100%;z-index:85285474;">
    <div class="row">
        <div class="col-md-8 col-12 text-center">
            <span class="cookies-notice" style="color:#ddd;font-size: 12px;"> {{__('cookies-t1')}}  <a href="{{get_url('terms')}}"> </a> {{__('cookies-t2')}} </span>
        </div>
        <div class="col-md-4 col-12 text-center mt-md-0 mt-2">
            <span class="cookies-button" style="color: #fff;background-color: #9c33c3;padding: 8px;cursor: pointer;">{{__('cookies-t3')}} </span>
        </div>
    </div>
</div>
<!-- loaders -->
...
<!--                <img src="{{get_theme_frontend_url('assets/sticky/logo-s.png')}}" style="width: 49px;z-index: 10;">-->
...
<script src="{{get_theme_frontend_url('assets/sticky/js/jquery-3.4.1.min.js')}}"></script>
<script src="{{get_theme_frontend_url('assets/sticky/js/jquery-ui.min.js')}}"></script>
<script src="{{get_theme_frontend_url('assets/sticky/js/popper.js')}}"></script>
<script src="{{get_theme_frontend_url('assets/sticky/js/bootstrap.min.js')}}"></script>
<script src="{{get_theme_frontend_url('assets/sticky/js/slick.min.js')}}"></script>
<script src="{{get_theme_frontend_url('assets/sticky/js/theme.js')}}"></script>
<script src="{{get_theme_frontend_url('assets/sticky/js/zenith.js')}}"></script>
<script src="{{get_theme_frontend_url('assets/sticky/js/jquery_cookies.js')}}"></script>
 @include('sticky.layout.partials.common.sweetalert')
    @include('sticky.layout.partials.common.inboundLeadScript',['selector'=>'.formevent','type'=>'event'])
    @include('sticky.layout.partials.common.inboundLeadScript',['selector'=>'.newsletter_subscription','type'=>'newsletterSubscription'])

@include('sticky.layout.partials.firebase')
<script>
