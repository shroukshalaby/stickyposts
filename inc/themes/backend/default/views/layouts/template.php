...
<body class="<?php _e( get_option('appearance_default_menu', 0)?"":"sidebar-small" )?>" id="sidebar-<?php _e( get_option('appearance_menu_color', "light") )?>">
	...
	<div class="header">
        ...
        <div class="topbar-left">
            ...
            <div class="item d-sm-block">
                <a href="https://stickyposts.net/affilate-system/affilate.php" ><i class="fas fa-dollar-sign"></i>
            ...
            <div class="item d-sm-block">
                <a href="https://stickyposts.net/sticky/pixie/" ><i class="fas fa-image"></i>
                    <span>Posts Generator</span>
                </a>
            </div>
            ...
            <div class="item d-sm-block">
                <a href="https://stickyposts.net/stickypost_register/payment-en.php?user_id=1009&amp;state=upgrade&amp;type=sticky" ><i class="fas fa-cube"></i>
            ...
            <div class="item d-sm-block">
                <a href="https://stickyposts.net/dashboard" ><i class="fas fa-home"></i>
                    <span>Home</span>
                </a>
            </div>
	...
	<div class="sidebar">
		...
		<div class="menu">
			...
			<?php endforeach ?>
			<div class="menu-item"  style="background:linear-gradient(90deg, #e09d0d, #d707f3);color:white;">
							<a href="javascript:void(0);">
								<span class="menu-icon"><i class="fab fa-autoprefixer" style="color:white;"></i></span>
								<span class="menu-desc" style="color:white;">Auto Activity</span>
							</a>
							...
							<ul class="submenu" style="display: none;">
																...
																<li class="" style="color:white!important;">
									<a href="https://stickyposts.net/instagram_activity">
										<span class="menu-icon"><i class="fas fa-circle"></i></span>
										<span class="menu-desc" style="color:white;">Instagram Auto Activity</span>
									</a>
								</li>
								<li class="" style="color:white!important;">
									<a href="https://stickyposts.net/pinterest_activity">
										<span class="menu-icon" style="color:white;"><i class="fas fa-circle"></i></span>
										<span class="menu-desc"style="color:white;">Pinterest Auto Activity</span>
									</a>
								</li>
															</ul>
						...
						<div class="menu-item" style="background:linear-gradient(90deg, #e09d0d, #d707f3);color:white;">
							<a href="https://stickyposts.net/phpanalyzer/product3/index.php">
								<span class="menu-icon"><i class="fas fa-users" style="color:white"></i></span>
								<span class="menu-desc" style="color:white!important;">Competitors & influencers</span>
							</a>
						...
						<div class="menu-item">
							<a href="https://stickyposts.net/LMS/">
								<span class="menu-icon"><i class="fas fa-chalkboard-teacher" style="color:#3AB2E5"></i></span>
								<span class="menu-desc">E-learning</span>
							</a>
						...
						<div class="menu-item">
							<a href="https://stickyposts.net/affilate-system/login1.php">
								<span class="menu-icon"><i class="fas fa-dollar-sign" style="color:yellow;"></i></span>
								<span class="menu-desc">Profit System</span>
							</a>
