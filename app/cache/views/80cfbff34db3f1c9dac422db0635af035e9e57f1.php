...
<div class="card" id="downForm" style="background: linear-gradient(275deg, #5e2298, #320b82);">
    <div class="card-header text-center p-0">
        <div class="py-1 text-center text-light" dir="ltr">
            ...
            <p style="margin:0;font-size:12px;color:#fff"><?php echo e(__('Downloadby')); ?><span style="margin-left:10px">[<?php echo $total_count ?>]</span><!--Kholy dinamic--> </p>
        </div>
    ...
    <div class="card-body p-1 text-light pricing-style-one">
        ...
        <ul class="nav nav-pills tab-title mb-1 row justify-content-center" id="pills-tab" role="tablist">
            <li class="nav-item col-4 px-0">
                <a class="nav-link active w-100 text-center px-0" id="pills-signup-tab" data-toggle="pill" href="#pills-signup" role="tab" aria-controls="pills-signup" aria-selected="true" style="line-height: 1.3;padding: 3px 10px;font-size: 15px;"><?php echo e(__('SIgnUp')); ?></a>
            </li>
            <li class="nav-item col-4 px-0">
                <a class="nav-link w-100 text-center px-0" id="pills-signin-tab" data-toggle="pill" href="#pills-signin" role="tab" aria-controls="pills-signin" aria-selected="false" style="line-height: 1.3;padding: 3px 10px;font-size: 15px;"><?php echo e(__('Login')); ?></a>
            </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
                ...
                <form style="direction:ltr" method="post" class="formres">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center;justify-content:center">
                        <div class="col-4 p-0 pl-2 text-start">
                            <label style="margin: 0;font-size:10px"> <span style="color:red">*</span><?php echo e(__('FirstName')); ?></label>
                        </div>
                        <div class="col-8 p-0">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center ;justify-content:center">
                        <div class="col-4 p-0 pl-2 text-start">
                            <label style="margin: 0;font-size:10px"> <span style="color:red">*</span><?php echo e(__('LastName')); ?></label>
                        </div>
                        <div class="col-8 p-0">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center;justify-content:center">
                        <div class="col-4 p-0 pl-2 text-start">
                            <label style="margin: 0;font-size: 10px;"> <span style="color:red">*</span><?php echo e(__('E-mail')); ?></label>
                        </div>
                        <div class="col-8 p-0">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center;justify-content:center">
                        <div class="col-4 p-0 pl-2 text-start">
                            <label style="margin: 0;font-size:10px"> <span style="color:red">*</span><?php echo e(__('Password')); ?>  </label>
                        </div>
                        <div class="col-8 p-0">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center;justify-content:center">
                        <div class="col-4 p-0 pl-2 text-start">
                            <label style="margin: 0;font-size:9px"> <span style="color:red">*</span><?php echo e(__('ConfirmPass')); ?></label>
                        </div>
                        <div class="col-8 p-0">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center ;justify-content:center">
                        <div class="col-4 p-0 pl-2 text-start">
                            <label style="margin: 0;font-size: 12px;" for=""><span style="color:red">*</span><?php echo e(__('Country')); ?></label>
                        </div>
                        <div class="col-8 p-0">
                    ...
                    <div class="form-group mb-1 row justify-content-center">
                        <button class="submit mt-2" type="submit" style="width:80%;border-radius: 5px;text-transform:capitalize;font-size: 17px; <?php echo e(getCurrentLangIdiom() == 'fr' ? 'font-size: 15px;'  : ''); ?>" name="submit" id="sub"><?php echo e(__('DownloadNow')); ?></button>
                    </div>
                </form>
            </div>
            <div class="tab-pane fade" id="pills-signin" role="tabpanel" aria-labelledby="pills-signin-tab">
                <form style="direction:ltr;" class="login" method="post">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center;justify-content:center">
                        <div class="col-4 p-0 pl-2 text-start">
                            <label style="margin: 0;font-size: 11px;"> <span style="color:red">*</span><?php echo e(__('E-mail')); ?></label>
                        </div>
                        <div class="col-8 p-0">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center;justify-content:center">
                        <div class="col-4 p-0 pl-2 text-start">
                            <label style="margin: 0;font-size:12px"> <span style="color:red">*</span> <?php echo e(__('Password')); ?> </label>
                        </div>
                        <div class="col-8 p-0">
                    ...
                    <div class="form-group row mb-1 mx-0" style="align-items:center;justify-content:center">
                        <div class="col-12 text-center px-4">
                            <a href="<?php echo e(get_url('foregt_password')); ?>" style="color: #fff;text-decoration: underline;"><?php echo e(__('forgetPassword')); ?></a>
                        </div>
                    </div>
                    <div class="form-group mb-1 row justify-content-center">
                         <button class="mt-2 col-6" type="submit" id="sub" name="login"
                                style="padding:3px 0 ;line-height: 1.3;font-size: 17px;background: linear-gradient(90deg,#42b0ff,#4262ff) !important;border: none;border-radius: 3px;color: #fff;"><?php echo e(__('Login')); ?>   
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="card-footer text-center text-light p-0" style="font-size: 9px;"><span style="color:#fff;margin-right:10px">( <span style="color:#f00">*</span> )</span><?php echo e(__('required_inputs')); ?></div>
</div>

<?php /**PATH F:\Laravel-Projects\StickyPost2\inc\themes\frontend\pure\views/sticky/layout/partials/common/pdfDownload.blade.php ENDPATH**/ ?>