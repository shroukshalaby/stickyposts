...
<?php $__env->startSection('body'); ?>
    ...
    <div class="cardSection mt-5 <?php echo e(getCurrentLangIdiom() == 'ar' ? 'text-right'  : ''); ?>" id="choose_payment">

        <div class="container p-0">
            <div id="payment-container" class="row">
                <div class="col-md-12 p-0 mt-4">
                    <div class="col-12 p-3 mt-5">
                        <h2 class="text-center glow" id="choose_payment" style="color:#320b82; "> Select Your
                            Pakckage </h2>
                    </div>
                    <div class="row mx-0 justify-content-center">
                        <div class="col-md-12 mx-auto p-0">
                                        ...
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                          <li class="nav-item">
                                            <a class="nav-link active sticky-active-background" onclick="ChangeBg(this.id)" id="pills-sticky-tab" data-toggle="pill" href="#pills-sticky" role="tab" aria-controls="pills-sticky" aria-selected="true"><?php echo e(__('stickyposts')); ?></a>
                                          </li>
                                          <li class="nav-item">
                                            <a class="nav-link" onclick="ChangeBg(this.id)" id="pills-auto-tab" data-toggle="pill" href="#pills-auto" role="tab" aria-controls="pills-auto" aria-selected="false"><?php echo e(__('b_AutoActivity')); ?></a>
                                          </li>
                                          <li class="nav-item">
                                            <a class="nav-link" onclick="ChangeBg(this.id)" id="pills-analayzer-tab" data-toggle="pill" href="#pills-analayzer" role="tab" aria-controls="pills-analayzer" aria-selected="false"><?php echo e(__('b_Competitors')); ?></a>
                                          </li>
                                          <li class="nav-item">
                                            <a class="nav-link" onclick="ChangeBg(this.id)" id="pills-family-tab" data-toggle="pill" href="#pills-family" role="tab" aria-controls="pills-family" aria-selected="false"><?php echo e(__('b_FamilyService')); ?></a>
                                          </li>
                                        </ul>
                                        <div class="tab-content" id="pills-tabContent">
                                          <div class="tab-pane fade show active" id="pills-sticky" role="tabpanel" aria-labelledby="pills-sticky-tab">
                                            <div class="row">
                                              <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               <?php if($package->slug=='econimcal' || $package->slug=='special' || $package->slug=='professional' || $package->slug=='super-professional'): ?>
                                                 <div class="col-sm-12 col-md-3 col-lg-3 col-xs-12 my-2">
                                                        <div class="single-pricing-one">
                                                            <div class="top-block priceContainer" dir="ltr">
                                                                <h2 class="mainBg">
                                                                    <input class="package" type="radio"
                                                                           value="<?php echo e($package->slug); ?>" id="<?php echo e($package->slug); ?>"
                                                                           name="package" data-slug="<?php echo e($package->slug); ?>"
                                                                           data-price-annually="<?php echo e($package->price_annually); ?>"
                                                                           data-price-monthly="<?php echo e($package->price_monthly); ?>"
                                                                           required>
                                                                    <label for="<?php echo e($package->id); ?>" class="pkTitle"><?php echo e($package->info['title'] ??''); ?></label>
                                                                </h2>
                                                                <p class="price m-0" dir="ltr"> <?php echo e($package->price_annually); ?> EGP </p>
                                                                <div data-package-id="<?php echo e($package->slug); ?>"
                                                                    ...
                                                                    <label data-period="monthly"
                                                                        ...
                                                                        <input type="radio" value="monthly" name="options"
                                                                               id="option2"
                                                                               autocomplete="off"> <?php echo e(__('monthly')); ?>
                                                            ...
                                                            <ul class="feature-lists text-start mx-2" dir="ltr">
                                                                ...
                                                                <?php $__currentLoopData = $package->info['features']??[]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <li><span class="red">*</span><?php echo e($feature); ?></li>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        
                                                            </ul>
                                                            <div class="bottom-block">
                                                                <h5 class="tag-line text-center">NO EXTRA FEES<br>CAN
                                          ...
                                          <div class="tab-pane fade" id="pills-auto" role="tabpanel" aria-labelledby="pills-auto-tab">
                                            <div class="row">
                                              <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               <?php if($package->slug=='econimcal-autoactivity' || $package->slug=='special-autoactivity'): ?>
                                                 <div class="col-sm-12 col-md-3 col-lg-3 col-xs-12 my-2">
                                                        <div class="single-pricing-one">
                                                            <div class="top-block priceContainer" dir="ltr">
                                                                <h2 class="mainBg">
                                          ...
                                          <div class="tab-pane fade" id="pills-analayzer" role="tabpanel" aria-labelledby="pills-analayzer-tab">
                                              <div class="row">
                                              <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               <?php if($package->slug=='econimcal' || $package->slug=='special' || $package->slug=='professional'): ?>
                                                 <div class="col-sm-12 col-md-3 col-lg-3 col-xs-12 my-2">
                                                        <div class="single-pricing-one">
                                                            <div class="top-block priceContainer" dir="ltr">
                                                                <h2 class="mainBg">
        ...
        <!--<----------------------------------switch to Premium--------------------------------------------->
        <div class="purchase_summary <?php echo e(getCurrentLangIdiom() == 'ar' ? 'text-right'  : ''); ?>" id="purchase">
            <div class="cc_title pt-4" id="subscription-form">
                <?php echo e(__('p1')); ?>

            </div>
            <div class="payment-page-section-subtitle js-free-trial-subtitle d-flex justify-content-center">
                <p class="first-charge-text">  <?php echo e(__('p2')); ?> <span
                            class="free-trial-accent font-weight-bold"><?php echo e(__('p24')); ?>  </span> <?php echo e(__('p3')); ?>

                <div class="circle-div pl-2 pos-rel">
                    <i class="fa fa-question-circle"></i>
                    <div class="info-mark__content">
                        <div class="info-mark__info-title font-weight-bold lh-15"><?php echo e(__('p4')); ?>  </div>
                        <ul class="credit-ul">
                            <li><?php echo e(__('p6')); ?>  </li>
                            <li><?php echo e(__('p7')); ?>  </li>
                        </ul>
                    </div>
                </div>
                </p>
            ...
            <div class="summary m-auto">
                <div class="container">
                    <div class="row justify-content-center js-mobile-start">
                        <div class="col-md-3 col-3 px-sm-0">
                            <p class="summary-purchase-subscription-name"><?php echo e(__('p8')); ?>  </p>
                        </div>
                        <div class="col-md-7 text-start col-9 px-sm-0">
                            <div class="form__row-column">
                                <div class="show-month">
                                    <p class="summary-purchase-subscription-name">
                                        <span class="purchase-summary__name-accent js-subscription-plan-period"><?php echo e(__('p9')); ?>  </span>
                                </div>
                                <div class="show-year" style="display:none">
                                    <p class="summary-purchase-subscription-name">
                                        <span class="purchase-summary__name-accent js-subscription-plan-period"><?php echo e(__('p10')); ?>  </span>
                                        <span class="purchase-summary__signnow-title purchase-summary__partners-titles purchase-summary__partners-titles--small"
                                              style="display: none;">
                                <span class="main-partners text-nowrap"><span class="bold"><?php echo e(__('p11')); ?>  </span></span>
                                <span class="text-nowrap">&amp; <span class="bold"><?php echo e(__('p12')); ?>  </span></span>
                            </span>
                                    </p>
                                </div>
                                    ...
                                    <div class="col-md-6 p-0">
                                        <div class="summary-purchase-switch-to-premium purchase-summary__premium-plan-benefits">
                                            <div class="purchase-summary__partners-titles purchase-summary__partners-titles--small">
                                                <p class="mb-0"><?php echo e(__('p13')); ?>  </p>

                                                <span class="main-partners text-nowrap"><span
                                                            class="bold"><?php echo e(__('p11')); ?>  </span></span>
                                                <span class="text-nowrap">&amp; <span
                                                            class="bold"><?php echo e(__('p12')); ?>  </span></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 p-0">
                                        <div class="switch-div pos-rel pl-md-2 pl-0">
                                            <button type="button"
                                                    class="btn-Premium  btn btn-secondary switchbtn-mov"><?php echo e(__('p23')); ?>  </button>
                                            <div class="switch-text-div">
                                                <div class="signnow-offer-title fs-10 font-weight-bold"><?php echo e(__('p15')); ?>  </div>
                                                <div class="signnow-offer-text fs-10"><?php echo e(__('p16')); ?> <span
                                                            class="nobr"><?php echo e(__('p17')); ?>  </span> <?php echo e(__('p18')); ?>  </div>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="summary-purchase-current-charge mt-3"><?php echo e(__('p19')); ?>
                                ...
                                <div class="summary-purchase-switch-to-premium__action">
                                    ...
                                    <div class="signnow-offer-details" style="display: none;">
                                        <div class="signnow-offer-title"><?php echo e(__('p15')); ?>  </div>
                                        <div class="signnow-offer-text"><?php echo e(__('p16')); ?> <span
                                                    class="nobr"><?php echo e(__('p17')); ?>  </span> <?php echo e(__('p18')); ?>  </div>
                                    </div>
                                </div>
                            </div>
                            <div class="summary-purchase-period row m-auto">
                                <div class="show-month col-md-6 p-0">
                                    <div class="summary-purchase-period__note">
                                        ...
                                        <?php echo e(__('p20')); ?> <span class="js-charge-amount pr-1">30 $</span>
                                        <span class="js-charge-amount-notice"></span>
                                        <span class="js-charge-period summary-purchase-period__charge"> <?php echo e(__('p21')); ?>  </span>
                                ...
                                <div class="show-year col-md-6 p-0" style="display:none">
                                    <div class="summary-purchase-period__note">
                                        <?php echo e(__('p20')); ?> <span class="js-charge-amount pr-1">30 $</span>
                                        <span class="js-charge-amount-notice"></span>
                                        <span class="js-charge-period summary-purchase-period__charge"> <?php echo e(__('p22')); ?>  </span>
                                        <div class="js-charge-amount-notice-text summary-purchase-period__tax-note"></div>
                                    </div>
                                </div>
                                <div class="plans-period-switcher-area col-md-6 p-0">
                                    <div class="row align-items-center mx-md-2">
                                            ...
                                            <div class="justify-content-center btn-group btn-group-toggle premiumToggle"
                                                ...
                                                <label id="premiumToggleYearly" data-period="yearly"
                                                    ...
                                                    <input type="radio" value="yearly" name="options2" id="option11"
                                                           autocomplete="off" checked> <?php echo e(__('yearly')); ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-3 text-center my-4">
                <a id="payment-button" class="btn payButton w-100" href="javascript:loadPayment()">PAY
...
<?php echo $__env->make('sticky.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel-Projects\StickyPost2\inc\themes\frontend\pure\views/sticky/pages/payment.blade.php ENDPATH**/ ?>