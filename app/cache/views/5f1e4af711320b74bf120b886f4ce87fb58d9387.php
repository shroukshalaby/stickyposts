...
<?php $__env->startSection('title','Sticky posts - Scheduling tool'); ?>
...
<?php $__env->startSection('page-wrapper'); ?>
    ...
    <div class="section-2 p-0 mt-2 mb-0" id="features">
        <div class="col-12 block-title text-center my-2">
            <h2><?php echo e(__('b_Features')); ?> </h2>
        </div><!-- /.block-title -->
        <div class="container">
                ...
                <div class="row w-75 mx-auto">
                    <div class=" col-12">
                        <div class="item" dir="ltr">
                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/dashboard/Schadualew.png')); ?>" class="img-fluid">
                            <div class="about">
                                <p class="m-0 style-box">
                                   <?php echo e(__('h_AutomatedScheduling')); ?>  </p>
                 <div class="caption style-captain " style=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'font-size:1.2rem'  : ''); ?>">                                         <?php echo e(__('h_auto_p')); ?></div>  
                            </div>
                        </div>
                    </div>
                    <div class=" col-12">
                        <div class="item" dir="ltr">
                            ...
                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/dashboard/time-managementw.png')); ?>" class="img-fluid">
                            <div class="about">
                                <p class="m-0 style-box">
                                    <?php echo e(__('h_TimeManagement')); ?> 
                                    </p>
                                <div class="caption" style=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'font-size:1.2rem'  : ''); ?>"
                                     >
                                 <?php echo e(__('h_TimeManagement_p')); ?>    
                                </div>
                            </div>
                    ...
                    <div class=" col-12">
                        <div class="item" dir="ltr">
                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/dashboard/Reportsw.png')); ?>" class="img-fluid">
                            <div class="about">
                                <p class="m-0 style-box">
                                    <?php echo e(__('h_Reports_Statistics')); ?> 
                                </p>
                                <div class="style-captain">
                                    <?php echo e(__('h_rep_p')); ?> 
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class=" col-12">
                        <div class="item" dir="ltr">
                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/dashboard/MultiDevicesWebsiteMockups.png')); ?>" class="img-fluid">
                            <div class="about">
                                <p class="m-0 style-box">
                                    <?php echo e(__('b_PostsGenerator')); ?> 
                                </p>
                                <div class="caption style-captain" style=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'font-size:1.2rem'  : ''); ?>">
                                    <?php echo e(__('h_posts_p')); ?> 
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class=" col-12">
                        <div class="item p-relative" dir="ltr">
                            ...
                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/dashboard/Autoreplyw.png')); ?>" class="img-fluid">
                            <div class="about">
                                <p class="m-0 style-box">
                                    <?php echo e(__('b_AutoActivity')); ?> 
                                </p>
                                <div class="caption style-captain"  style=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'font-size:1.2rem'  : ''); ?>">
                                    <?php echo e(__('h_auto_p_s')); ?> 
                                </div>
                            </div>
                            <div class="bottom-block">
                                <a href="<?php echo e(get_url('auto_activity')); ?>" class="btn btn-info bg-border-btn">
                                   
                                    <?php echo e(__('get_it_now')); ?> 
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class=" col-12">
                        <div class="item p-relative" dir="ltr" >
                            ...
                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/dashboard/Analyzerw.png')); ?>" class="img-fluid">
                            <div class="about">
                                <p class="m-0 style-box">
                                  <?php echo e(__('b_Competitors')); ?>

                                </p>
                                <div class="caption style-captain" style="<?php echo e(getCurrentLangIdiom() == 'fr' ? 'font-size:1.2rem'  : ''); ?>">
                                     <?php echo e(__('h_Competitors_p')); ?> 
                                </div>
                            </div>
                            ...
                            <div class="item" dir="ltr" style="height: 171px;">
                                <div class="icon mb-1">
                                    <div class="row mx-aut0 w-100">
                                        <div class="col-4">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/icon/Schadule.png')); ?>" class="img-fluid">
                                        </div>
                                        <div class="col-8 my-auto">
                                            <p class="text-white para-m m-0">
                                                 <?php echo e(__('h_AutomatedScheduling')); ?> 
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="caption"> <?php echo e(__('h_auto_p')); ?></div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 mb-3">
                            <div class="item" dir="ltr" style="height: 171px;">
                                <div class="icon mb-1">
                                    <div class="row mx-aut0 w-100">
                                        <div class="col-4">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/icon/time.png')); ?>" class="img-fluid">
                                        </div>
                                        <div class="col-8 my-auto">
                                            <p class="text-white para-m m-0"><?php echo e(__('h_TimeManagement')); ?> </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 mb-3">
                            <div class="item" dir="ltr" style="height: 171px;">
                                <div class="icon mb-1">
                                    <div class="row mx-aut0 w-100">
                                        <div class="col-4">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/icon/reports.png')); ?>" class="img-fluid">
                                        </div>
                                        <div class="col-8 my-auto">
                                            <p  class="text-white para-m m-0"> <?php echo e(__('h_Reports_Statistics')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="caption"> <?php echo e(__('h_rep_p')); ?></div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="item p-relative" dir="ltr" style="height:171px;">
                                <div class="icon mb-1">
                                    <div class="row mx-aut0 w-100">
                                        <div class="col-4">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/icon/Family.png')); ?>" class="img-fluid" style="width: 86%;">
                                        </div>
                                        <div class="col-8 my-auto">
                                            <p class="text-white para-m m-0">
                                              <?php echo e(__('h_Family')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="caption"><?php echo e(__('h_Family_p')); ?> </div>
                                <div class="bottom-block">
                                    <a href="<?php echo e(get_url('family')); ?>" class="btn bg-border-btn-2">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="item p-relative" dir="ltr" style="height:171px;">
                                <div class="icon mb-1">
                                    <div class="row mx-aut0 w-100">
                                        <div class="col-4">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/icon/auto-reply.png')); ?>" class="img-fluid">
                                        </div>
                                        <div class="col-8 my-auto">
                                            <p class="text-white para-style" ><?php echo e(__('b_AutoActivity')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="caption"><?php echo e(__('h_auto_p_s')); ?></div>
                                <div class="bottom-block">
                                    <a href="<?php echo e(get_url('auto_activity')); ?>" class="btn btn-info bg-border-btn">
                                      <?php echo e(__('get_it_now')); ?>  </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="item p-relative " dir="ltr" style="height:171px;">
                                <div class="icon mb-1">
                                    <div class="row mx-aut0 w-100">
                                        <div class="col-4">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/icon/competitors.png')); ?>" class="img-fluid">
                                        </div>
                                        <div class="col-8 my-auto">
                                ...
                                <div class="caption"><?php echo e(__('h_Competitors_p')); ?></div>
                                <div class="bottom-block">
                        ...
                        <div class="icon mb-0">
                            <div class="row m-0" style="background:#fff;">
                                <div class="col-8 text-center">
                                    <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/PostsGererator BK.png')); ?>" class="img-fluid img-style-height">
                                </div>
                                <div class="col-4">
                                    <div class="new_text">
                                        <p class="new_text_p"><?php echo e(__('New')); ?></p>
                                    </div>
                            ...
                            <div class="column">
                                <div class="column-new-style">
                                    <ul class="ul-column-new-style text-light">
                                        <li class=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'lh-french-12'  : ''); ?>"><span><?php echo e(__('h_pg_li_1')); ?></span></li>
                                        <li class=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'lh-french-12'  : ''); ?>"><span><?php echo e(__('h_pg_li_2')); ?></span></li>
                                        <li class=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'lh-french-12'  : ''); ?>"><span><?php echo e(__('h_pg_li_3')); ?></span></li>
                                        <li class=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'lh-french-12'  : ''); ?>"><span><?php echo e(__('h_pg_li_4')); ?></span></li>
                                        <li class=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'lh-french-12'  : ''); ?>"><span><?php echo e(__('h_pg_li_5')); ?></span></li>
                                        <li class=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'lh-french-12'  : ''); ?>"><span><?php echo e(__('h_pg_li_6')); ?></span></li>
                                        <li class=" <?php echo e(getCurrentLangIdiom() == 'fr' ? 'lh-french-12'  : ''); ?>"><span><?php echo e(__('h_pg_li_7')); ?></span></li>
                                    </ul>
                                </div>
                                <a href="<?php echo e(get_url('posts_generator')); ?>" class="btn blowing-button btn-new-style-border">
                                   <?php echo e(__('get_it_now')); ?> <?php echo e(__('free')); ?> <br><span class="span-new-style-blow"><?php echo e(__('h_pg_included')); ?></span></a>
    ...
    <section class="services-style-one p-0 mb-3" id="service">
        <div class="" id="WhoBenefit">
            <div class="block-title text-center">
                <h2><?php echo e(__('h_benefit')); ?></h2>
                <h6 class=" text-black   "><?php echo __('h_benefit_p'); ?></h6>
            </div><!-- /.block-title -->
            ...
            <div class="row text-center col-lg-9 mx-auto">
                <div class="col-lg-4 col-md-4 col-sm-6 pad-fre">
                    <div class="new-item">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/new/ngo.png')); ?>" class="img-fluid hide-mobile">
                        <p class="mb-2 ngo-new-style">
                         <?php echo e(__('h_ngo')); ?>

                        </p>
                        <a href="<?php echo e(get_url('more_benefits#card3')); ?>" class="hide-mobile read-more-color">
                         <?php echo e(__('readMore')); ?></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 pad-fre">
                    <div class="new-item">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/new/brand.png')); ?>" class="img-fluid hide-mobile">
                        <p class="mb-2 img-new-style-bottom">
                          <?php echo __('h_brands'); ?> 
                        </p>
                        <a href="<?php echo e(get_url('more_benefits#card2')); ?>" class="hide-mobile img-new-style-read-more">
                           <?php echo e(__('readMore')); ?> </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 pad-fre">
                    <div class="new-item">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/new/ecom.png')); ?>" class="img-fluid hide-mobile">
                        <p class="mb-2 para-electronic">
                            <?php echo e(__('h_electronic')); ?>

                        </p>
                        <a href="<?php echo e(get_url('more_benefits#card1')); ?>" class="hide-mobile more-benefits-new-style">
                            <?php echo e(__('readMore')); ?></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 mt-md-3 mt-0 pad-fre">
                    <div class="new-item">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/new/egancy.png')); ?>" class="img-fluid hide-mobile">
                        <p class="mb-2 ads-new-style">
                            <?php echo __('h_ads'); ?>

                        </p>
                        <a href="<?php echo e(get_url('more_benefits#card6')); ?>" class="hide-mobile card6-new-style">
                            <?php echo e(__('readMore')); ?></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 mt-md-3 mt-0 pad-fre">
                    <div class="new-item">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/new/freelancer.png')); ?>" class="img-fluid hide-mobile">
                        <p  class="mb-2 card7-new-style">
                          <?php echo e(__('h_freelance')); ?>  
                        </p>
                        <a href="<?php echo e(get_url('more_benefits#card5')); ?>" class="hide-mobile card5-new-style">
                           <?php echo e(__('readMore')); ?></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 mt-md-3 mt-0 pad-fre">
                    <div class="new-item">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/new/influ.png')); ?>" class="img-fluid hide-mobile">
                        <p class="mb-2 influencer-new-style">
                           <?php echo e(__('h_influencer')); ?> 
                        </p>
                        <a href="<?php echo e(get_url('more_benefits#card4')); ?>" class="hide-mobile card4-new-style">
                           <?php echo e(__('readMore')); ?>

                        </a>
                    </div>
                </div>
                <a href="<?php echo e(get_url('more_benefits')); ?>" class="m-auto view-mobile mt-2 card10-new-style">
                  <?php echo e(__('readMore')); ?>
        ...
        <div class="container">
            ...
            <div class="row" id="benefits">
                <div class="col-12 block-title text-center m-0">
                    <h2 class="hide-mobile mb-4"><?php echo e(__('benefits')); ?></h2>
                    <h2 class="view-mobile my-5"><?php echo e(__('h_free_e_book')); ?></h2>
                </div><!-- /.block-title -->
                                ...
                                <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 left-row">
                                    <ul class="features-left">
                                        <li class="highlight lhgh" data-index="0">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/Increase-Clients.png')); ?>">
                                            <div class="fl-inner b-10">
                                                <h4><?php echo e(__('h_benefit_h1')); ?></h4>
                                                <p><?php echo e(__('h_benefit_p1')); ?></p>
                                            </div>
                                        </li><!-- .highlight .left-row -->

                                        <li class="highlight lhgh" data-index="1">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/Reports.png')); ?>">
                                            <div class="fl-inner b-10">
                                                <h4><?php echo e(__('h_benefit_h2')); ?></h4>
                                                <p><?php echo e(__('h_benefit_p2')); ?></p>
                                            </div>
                                        </li><!-- .highlight .left-row -->

                                        <li class="highlight lhgh" data-index="2">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/increase-sale.png')); ?>">
                                            <div class="fl-inner b-10">
                                                <h4><?php echo e(__('h_benefit_h3')); ?></h4>
                                                <p><?php echo e(__('h_benefit_p3')); ?></p>
                                            </div>
                                        </li><!-- .highlight .left-row -->
                                        <li class="highlight lhgh" data-index="3">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/Auto-Reply.png')); ?>">
                                            <div class="fl-inner b-10">
                                                <h4><?php echo e(__('h_benefit_h4')); ?></h4>
                                                <p><?php echo e(__('h_benefit_p4')); ?></p>
                                            </div>
                                        </li><!-- .highlight .left-row -->
                                    </ul>
                                </div>
                                    ...
                                    <div class="phone-holder">
                                        ...
                                        <div class="hgh-linner hgi" data-index="0">
                                            <img width="190" height="320"
                                                 src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/phone/increase-Clients.png')); ?>"
                                                 class="attachment-highlight wp-post-image" alt="screen"/>
                                        </div>
                                        <div class="hgh-linner hgi" data-index="1">
                                            <img width="234" height="398" src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/phone/reports.png')); ?>"
                                                 class="attachment-highlight wp-post-image" alt="screensdst"/>
                                        </div>
                                        <div class="hgh-linner hgi" data-index="2">
                                            <img width="234" height="398"
                                                 src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/phone/increase-sales.png')); ?>"
                                                 class="attachment-highlight wp-post-image" alt="screen_09"/>
                                        </div>
                                        <div class="hgh-rinner hgi" data-index="3">
                                            <img width="234" height="398" src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/phone/auto-reply.png')); ?>"
                                                 class="attachment-highlight wp-post-image" alt="screen_07"/>
                                        </div>
                                        <div class="hgh-rinner hgi" data-index="4">
                                            <img width="234" height="398" src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/phone/Scadule.png')); ?>"
                                                 class="attachment-highlight wp-post-image" alt="screen_08"/>
                                        </div>
                                        <div class="hgh-rinner hgi" data-index="5">
                                            <img width="234" height="398" src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/phone/Team.png')); ?>"
                                                 class="attachment-highlight wp-post-image" alt="screen_06"/>
                                        </div>
                                        <div class="hgh-rinner hgi" data-index="6">
                                            <img width="234" height="398"
                                                 src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/phone/Competetitors.png')); ?>"
                                                 class="attachment-highlight wp-post-image" alt="screen_06"/>
                                        </div>
                                        <div class="hgh-rinner hgi" data-index="7">
                                            <img width="234" height="398" src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/phone/Time.png')); ?>"
                                                 class="attachment-highlight wp-post-image" alt="screen_06"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-8 col-sm-12 col-xs-12 right-row">
                                    <ul class="features-right">
                                        <li class="highlight rhgh" data-index="4">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/Schadule.png')); ?>">
                                            <div class="fr-inner b-10">
                                                <h4><?php echo e(__('h_benefit_h5')); ?></h4>
                                                <p><?php echo e(__('h_benefit_p5')); ?></p>
                                            </div>
                                        </li><!-- .highlight .left-row -->
                                        <li class="highlight rhgh" data-index="5">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/Team.png')); ?>">
                                            <div class="fr-inner b-10">
                                                <h4><?php echo e(__('h_benefit_h6')); ?></h4>
                                                <p><?php echo e(__('h_benefit_p6')); ?></p>
                                            </div>
                                        </li><!-- .highlight .left-row -->
                                        <li class="highlight rhgh" data-index="6">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/Influencer.png')); ?>">
                                            <div class="fr-inner b-10">
                                                <h4><?php echo e(__('h_benefit_h7')); ?></h4>
                                                <p> <?php echo e(__('h_benefit_p7')); ?></p>
                                            </div>
                                        </li><!-- .highlight .left-row -->
                                        <li class="highlight rhgh" data-index="7">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/mobileslider/Time.png')); ?>">
                                            <div class="fr-inner b-10">
                                                <h4><?php echo e(__('h_benefit_h8')); ?></h4>
                                                <p><?php echo e(__('h_benefit_p8')); ?></p>
                                            </div>
                                        </li><!-- .highlight .left-row -->
                                    </ul>
                                </div>
    ...
    <?php echo $__env->make('sticky.layout.partials.common.pricing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #200846;color: #fff;">
                    <h5 class="modal-title" id="exampleModalLabel"><img src="<?php echo e(get_theme_frontend_url('assets/sticky/logo-s.png')); ?>" width='49px'></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content"
                ...
                <div class="modal-header p-0" style="position: relative;height: 50px;border-bottom: none;">
                    <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/storm-log2.png')); ?>" class="hide-mobile"
                         style="width: 200px;z-index:10;position: absolute;bottom:-70px;transform: translate(73%, 0px);">
                    <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/storm-log2.png')); ?>" class="view-mobile"
                ...
                <div class="modal-bodystart text-center" style="padding: 50px 15px 15px 15px;">
                    ...
                    <a href="<?php echo e(get_url('register')); ?>" class="submit popup-btn" style="line-height: 1.5;height: 35px;border-radius: 5px; font-size: 1.5rem;font-weight: 600;background: #f9c412 !important;color: #320b82;">Start Now</a>
                </div>
            </div>
...
<?php echo $__env->make('sticky.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel-Projects\StickyPost2\inc\themes\frontend\pure\views/sticky/home.blade.php ENDPATH**/ ?>