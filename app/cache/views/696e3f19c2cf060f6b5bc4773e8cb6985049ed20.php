...
<?php $__env->startSection('body'); ?>
    <div class="page-wrapper <?php echo e(getCurrentLangIdiom() == 'ar' ? 'text-right'  : ''); ?>">
        <div class="container mt-5 py-5">
            <h2 class="text-center text-dark blade-color1"><strong><?php echo e(__('dev-strong')); ?></strong></h2>
                        ...
                        <form class="addDeveloper" method="post">
                            <div class="form-row mb-0">
                                <div class="col-md-12 mb-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                               id="validationDefaultUsername" placeholder="<?php echo e(__('dev-Name')); ?>"
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="company" class="form-control"
                                               id="validationDefaultUsername" placeholder="<?php echo e(__('dev-Company')); ?>"
                                               aria-describedby="inputGroupPrepend2" required>
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                               id="validationDefaultUsername" placeholder="<?php echo e(__('dev-mail')); ?>"
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <sm class="blade-font1"><span class="blade-color3">( * )</span><?php echo e(__('dev-us.')); ?>

                                    </sm>
                                </div>
                            </div>
                            <label for="validationTextarea"><?php echo e(__('dev-to')); ?></label>
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label fs-13"
                                       for="customControlValidation2"><?php echo e(__('dev-get')); ?></label>
                            </div>
                            <div class="custom-control custom-radio mb-3">
                                ...
                                <label class="custom-control-label fs-13"
                                       for="customControlValidation3"><?php echo e(__('dev-api')); ?></label>
                            </div>
                            <button class="submit w-100" type="submit" name="developer"><?php echo e(__('dev-re')); ?></button>
                        </form>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-7 text-start my-auto  mt-3">
                    <div class="card box-shadow blade-color4">
                        ...
                        <div class="card-body text-light p-1">
                            <h6 class="mb-0 py-2"><?php echo e(__('dev-be')); ?></h6>
                            <p><?php echo e(__('dev-app')); ?> </p>
                            <p class="mb-0"><?php echo e(__('dev-app2')); ?></p>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('scripts'); ?>
    <?php echo $__env->make('sticky.layout.partials.common.inboundLeadScript',['selector'=>'.addDeveloper','type'=>'developers'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopPush(); ?>
        
<?php echo $__env->make('sticky.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel-Projects\StickyPost2\inc\themes\frontend\pure\views/sticky/pages/developers.blade.php ENDPATH**/ ?>