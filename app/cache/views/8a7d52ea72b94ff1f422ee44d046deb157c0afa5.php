...
<section class="<?php echo e(getCurrentLangIdiom() == 'ar' ? 'text-right'  : ''); ?>">
 <section class="banner_section" style="">
            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/Back to BusinessEN.jpg')); ?>" class="img-fluid">
        </section>
        <div class="client-section">
            <div class="container text-center">
                <div class="clients">
                    <div class="single">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client1.png')); ?>" class='none' alt="Client" />
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client1-c.png')); ?>" class="color" alt="Client" />
                    </div>
                    <div class="single">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client3.png')); ?>" class='none' alt="Client" />
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client3-c.png')); ?>" class="color" alt="Client" />
                    </div>
                    <div class="single">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client5.png')); ?>" class='none' alt="Client" />
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client5-c.png')); ?>" class="color" alt="Client" />
                    </div>
                    <div class="single">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client6.png')); ?>" class='none' alt="Client" />
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client6-c.png')); ?>" class="color" alt="Client" />
                    </div>
                    <div class="single">
                    ...
                    <div class="single">
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client7.png')); ?>" class='none' alt="Client" />
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/client7-c.png')); ?>" class="color" alt="Client" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 py-md-4 py-3">
                          ...
                          <?php echo e(__('land-moreProductivity')); ?>

                        </h1>
                        <h4 class="text-sticky text-center">
                        <?php echo __('land-businessAndSuccess'); ?>
                        ...
                        <div class="guide-back mt-3">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <?php echo __('land-digitalSolutions'); ?>

                                        <span class="font-weight-bold">
                                        <?php echo e(__('land-moreThan')); ?>

                                        </span>
                                        <br>
                                        <span class="font-weight-bold">
                                        <?php echo e(__('land-permonth')); ?>

                                        </span>
                                    </h2>
                                    <h2 class="title-sticky text-center d-md-none d-block mb-3" style="font-size: 30px;">
                                    <?php echo e(__('land-providedDigital')); ?>
                ...
                <div class="row d-md-flex d-none">
                    <div class="col-4">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <?php echo e(__('land-AvailableAppointments')); ?>
                            ...
                            <?php echo e(__('land-IncreaseRevenues')); ?> 
                                <i class="fas fa-angle-right float-right"></i>
                            </a>
                            ...
                            <?php echo e(__('land-businessRange')); ?>
                            ...
                            <?php echo e(__('land-smoothlyAndEasily')); ?>
                            ...
                            <?php echo e(__('land-ProvideInfrastructure')); ?>
                            ...
                            <?php echo e(__('land-ProfessionalCustomer')); ?>
                        ...
                        <div class="tab-content basics_tabs" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-basics1" role="tabpanel" aria-labelledby="v-pills-basics1-tab">
                                <div class="row">
                                    <div class="col-7">
                                        ...
                                        <?php echo e(__('land-customersBase')); ?>

                                        </h3> 
                                        <ul class="text-sticky mb-4">
                                            <li>
                                            <?php echo e(__('land-StrongPresence')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-BuildWebPage')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-teamAutomatically')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-SavingTime')); ?>

                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-4 p-0">
                                       <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/back_to_business/available appoitment.jpg')); ?>" class="img-fluid w-100"/>   
                                    </div>      
                            ...
                            <div class="tab-pane fade" id="v-pills-basics2" role="tabpanel" aria-labelledby="v-pills-basics2-tab">
                                <div class="row">
                                    <div class="col-7">
                                        <h3 class="mt-3 mb-1 text-sticky">
                                        <?php echo e(__('land-IncreaseRevenue')); ?>

                                        </h3>
                                        <ul class="text-sticky mb-4">
                                            <li>
                                            <?php echo e(__('land-marketingEveryMonth')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-mostImportantFactor')); ?> 
                                            </li>
                                            <li>
                                            <?php echo e(__('land-ConstantlyGaining')); ?>

                                            </li>
                                        </ul>
                                    </div>
                                      <div class="col-4 p-0">
                                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/back_to_business/Increase revenue.jpg')); ?>" class="img-fluid w-100"/> 
                                      </div>
                                    <div class="col-1 bg-basics-content">
                            ...
                            <div class="tab-pane fade" id="v-pills-basics3" role="tabpanel" aria-labelledby="v-pills-basics3-tab">
                                <div class="row">
                                    <div class="col-7">
                                        <h3 class="mt-3 mb-1 text-sticky">
                                        <?php echo e(__('land-businessRangeBy')); ?>

                                        </h3>
                                        <ul class="text-sticky mb-4">
                                            <li>
                                            <?php echo e(__('land-BuildingDigital')); ?>
                                            ...
                                            <li>
                                            <?php echo e(__('land-FacilitatingE-payment')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-businessDevelopment')); ?>

                                            </li>
                                        </ul>
                                    </div>
                                      <div class="col-4 p-0">
                                          <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/back_to_business/Expand your business.jpg')); ?>" class="img-fluid w-100"/> 
                                    </div>
                                    <div class="col-1 bg-basics-content">
                            ...
                            <div class="tab-pane fade" id="v-pills-basics4" role="tabpanel" aria-labelledby="v-pills-basics4-tab">
                                <div class="row">
                                    <div class="col-7">
                                        <h3 class="mt-3 mb-1 text-sticky">
                                        <?php echo e(__('land-businessTeam')); ?>

                                        </h3>
                                        <ul class="text-sticky mb-4">
                                            <li>
                                            <?php echo e(__('land-teamManagement')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-performanceRates')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-LinkingAllProjects')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-DetailedReports')); ?>

                                            </li>
                                        </ul>
                                    </div>
                                      <div class="col-4 p-0">
                                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/back_to_business/Manage your business.jpg')); ?>" class="img-fluid w-100"/>   
                                      </div>
                                    <div class="col-1 bg-basics-content">
                            ...
                            <div class="tab-pane fade" id="v-pills-basics5" role="tabpanel" aria-labelledby="v-pills-basics5-tab">
                                <div class="row">
                                    <div class="col-7">
                                        <h3 class="mt-3 mb-1 text-sticky">
                                        <?php echo e(__('land-ProvideInfrastructureBusiness')); ?>

                                        </h3>
                                        <h3 class="nav-title text-sticky mb-4">
                                        <?php echo __('land-basicInfrastructure'); ?>

                                        </h3>
                                    </div>
                                      <div class="col-4 p-0">
                                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/back_to_business/Provide an infrastructure.jpg')); ?>" class="img-fluid w-100"/>
                                      </div>
                                    <div class="col-1 bg-basics-content">
                            ...
                            <div class="tab-pane fade" id="v-pills-basics6" role="tabpanel" aria-labelledby="v-pills-basics6-tab">
                                <div class="row">
                                    <div class="col-7">
                                        <h3 class="mt-3 mb-1 text-sticky">
                                        <?php echo e(__('land-CustomersProfits')); ?>

                                        </h3>
                                        <h3 class="nav-title text-sticky">
                                        <?php echo e(__('land-higherPercentage')); ?>

                                        </h3>
                                        <h3 class="nav-title text-sticky mb-4">
                                        <?php echo e(__('land-consumerToday')); ?>

                                        </h3>
                                    </div>
                                      <div class="col-4  p-0">
                                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/back_to_business/PROFIT=COST.jpg')); ?>" class="img-fluid w-100"/>     
                                      </div>
                                    <div class="col-1 bg-basics-content">
                            ...
                            <div class="tab-pane fade" id="v-pills-basics7" role="tabpanel" aria-labelledby="v-pills-basics7-tab">
                                <div class="row">
                                    <div class="col-7">
                                        <h3 class="mt-3 mb-1 text-sticky">
                                            <?php echo __('land-cust-satis'); ?>

                                        </h3>
                                        <h3 class="nav-title text-sticky">
                                            <?php echo e(__('land-if-any')); ?>

                                        </h3>
                                        <h3 class="nav-title text-sticky mb-4">
                                            <?php echo e(__('land-gain-cust')); ?>

                                        </h3>
                                    </div>
                                      <div class="col-4 p-0">
                                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/back_to_business/Customer Satisfaction.jpg')); ?>" class="img-fluid w-100"/>                 
                                        </div>
                                    <div class="col-1 bg-basics-content">
                                ...
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            <?php echo e(__('land-increase-cust')); ?> 
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                       <?php echo e(__('land-salesChannels')); ?> 
                                                    </li>
                                                    <li>
                                                        <?php echo e(__('land-FacilitatingE-payment')); ?> 
                                                    </li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <p class="">
                                                     <?php echo e(__('land-basicInfrastructure')); ?>
                                ...
                                <div class="card-header" id="headingSeven">
                                    <h2 class="mb-0">
                                        <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                            <?php echo e(__('land-customersLoyalty')); ?> 
                                            <i class="fas fa-angle-down float-right"></i>
                                        </button>
                                    </h2>
                                </div>
                        ...
                        <div class="row">
                              ...
                              <h5 class="panel-title mb-0">
                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1">
                                   <div class="program-sponcer-logo">
                                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/Final New landing page maker2.png')); ?>" class="img-fluid w-100">
                                    </div>
                                     <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                                </button>
                              </h5>
                            </div>
                              ...
                              <div class="card-body">
                                  <div class="cardbody1">
                                      <p class="mb-1 text-sticky">
                                           <?php echo e(__('land-provide')); ?>:-
                                        </p>
                                        <ul class="text-sticky pl-3">
                                            <li>
                                              <?php echo e(__('land-unlim')); ?>

                                            </li>
                                            <li>
                                             <?php echo e(__('land-html')); ?>

                                            </li>
                                            <li>
                                             <?php echo e(__('land-alter')); ?>

                                            </li>
                                            <li>
                                             <?php echo e(__('land-export')); ?>

                                            </li>
                                            <li>
                                            <?php echo e(__('land-publish')); ?>    
                                            </li>
                                            <li>
                                             <?php echo e(__('land-preview')); ?>   
                                            </li>
                                        </ul>   
                                  </div>
                                   <div class="cardbody2">
                                    <div class="col-12 p-0">  
                                     <a class="start-now w-100" href="#packages"> <?php echo e(__('temp-getItNow')); ?> </a>
                                    </div>  
                                  </div>
                              </div>
                          ...
                          <div class="panel panel-default col-md p-2">
                            <div class="panel-heading m-0 p-0  program-sponcer-section" id="headingTwo2">
                              <h5 class="panel-title mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo2">
                                        <div class="program-sponcer-logo">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/Done-Tasks-Wh.png')); ?>" class="img-fluid w-100">
                                        </div>
                                         <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                            ...
                            <div id="collapseTwo2" class="panel-collapse collapse mt-3">
                              <div class="card-body">
                                <div class="cardbody1">
                                    <p class="mb-1 logo-p-text"><?php echo e(__('land-platform')); ?> </p>
                                       <p class="mb-1 text-sticky">
                                            <?php echo e(__('land-don-task')); ?>

                                        </p>
                                        <ul class="text-sticky pl-3">
                                            <li>
                                                <?php echo e(__('land-man-unlim')); ?>

                                            </li>
                                            <li>
                                                <?php echo e(__('land-man-unlim-tas')); ?>

                                            </li>
                                            <li>
                                                <?php echo e(__('land-unlim-stor')); ?>

                                            </li>
                                            <li>
                                                <?php echo e(__('land-support')); ?>
                          ...
                          <div class="panel panel-default col-md p-2">
                            <div class="panel-heading m-0 p-0  program-sponcer-section" id="headingThree3">
                              <h5 class="panel-title mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree3" aria-expanded="false" aria-controls="collapseThree3">
                                        <div class="program-sponcer-logo">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/logo-1-1.png')); ?>" class="img-fluid w-100">
                                        </div>
                                         <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                            ...
                            <div id="collapseThree3" class="panel-collapse collapse mt-3">
                              <div class="card-body">
                                    <div class="cardbody1">
                                  <p class="mb-1 logo-p-text"> <?php echo e(__('land-economical-soc')); ?> </p>
                                        <p class="mb-1 text-sticky">
                                         <?php echo e(__('land-stick-prov')); ?>

                                        </p>
                                        <ul class="text-sticky pl-3">
                                            <li>
                                            <?php echo e(__('fam-Auto Scheduling')); ?>

                                            </li>
                                            <li>
                                               <?php echo e(__('land-auto-rep')); ?>

                                            </li>
                                            <li>
                                              <?php echo e(__('land-trac-inf')); ?>

                                            </li>
                                            <li>
                                              <?php echo e(__('land-rep-anal')); ?>

                                            </li>
                                            <li>
                                              <?php echo e(__('fam-Posts Generator')); ?>
                          ...
                          <div class="panel panel-default col-md p-2">
                            <div class="panel-heading m-0 p-0  program-sponcer-section" id="headingFour4">
                              <h5 class="panel-title mb-0">
                                <button class="btn btn-link w-100" data-toggle="collapse" data-target="#collapseFour4" aria-expanded="true" aria-controls="collapseFour4">
                                        <div class="program-sponcer-logo">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/emblem-Samsung.jpg')); ?>" class="img-fluid w-100">
                                        </div>
                                         <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                            ...
                            <div id="collapseFour4"  class="panel-collapse collapse mt-3">
                              <div class="card-body">
                                <div class="cardbody1">  
                                  <p class="mb-1 text-sticky">
                                           <?php echo e(__('land-samsu-wil')); ?>

                                </p>
                                        <ul class="text-sticky mb-4  pl-3">
                                            <li>
                                               <?php echo e(__('land-laptop')); ?>

                                            </li>
                                            <li>
                                               <?php echo e(__('land-tablet')); ?>
                          ...
                          <div class="panel panel-default col-md p-2">
                            <div class="panel-heading m-0 p-0  program-sponcer-section" id="headingFive5">
                              <h5 class="panel-title mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFive5" aria-expanded="false" aria-controls="collapseFive5">
                                        <div class="program-sponcer-logo">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/orange.jpg')); ?>" class="img-fluid w-75 orange w-50mobile">
                                        </div>
                                         <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                            ...
                            <div id="collapseFive5"  class="panel-collapse collapse mt-3">
                              <div class="card-body">
                                    <div class="cardbody1">  
                                  <p class="mb-1 text-sticky">
                                            <?php echo e(__('land-orange-tele')); ?>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="panel-heading m-0 p-0  program-sponcer-section" id="headingSix6">
                              <h5 class="panel-title mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSix6" aria-expanded="false" aria-controls="collapseSix6">
                                        <div class="program-sponcer-logo">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/autochat.png')); ?>" class="img-fluid w-100">
                                        </div>
                                         <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                            ...
                            <div id="collapseSix6"  class="panel-collapse collapse mt-3">
                              <div class="card-body">
                                    <div class="cardbody1">    
                                  <p class="mb-1 text-sticky">
                                            <?php echo e(__('land-best-mess')); ?>

                                        </p>
                                       <ul class="text-sticky m-0 pl-3">
                                            <li>
                                              <?php echo e(__('land-bulk-mess')); ?>
                                            ...
                                            <li>
                                             <?php echo e(__('land-auto-pri')); ?>

                                            </li>
                                            
                                            <li>
                                             <?php echo e(__('land-tex-img')); ?>

                                            </li>
                                             <li>
                                             <?php echo e(__('land-pag-mess')); ?>

                                            </li>
                                            <li>
                                             <?php echo e(__('land-bot-rep')); ?>
                            ...
                            <div class="panel-heading m-0 p-0  program-sponcer-section" id="headingSeven7">
                              <h5 class="panel-title mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSeven7" aria-expanded="false" aria-controls="collapseSeven7">
                                    <div class="program-sponcer-logo">
                                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/idigitalhr.png')); ?>" class="img-fluid w-100">
                                    </div>
                                     <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                            ...
                            <div class="panel-heading m-0 p-0  program-sponcer-section" id="headingEight8">
                              <h5 class="panel-title mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEight8" aria-expanded="false" aria-controls="collapseEight8">
                                        <div class="program-sponcer-logo">
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/Templates001 Logo.png')); ?>" class="img-fluid w-100">
                                        </div>
                                         <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                            ...
                            <div id="collapseEight8"  class="panel-collapse collapse mt-3">
                              <div class="card-body">
                                    <div class="cardbody1">    
                               <p class="mb-1 text-sticky">
                                            <?php echo e(__('land-template001')); ?>
                                ...
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseNine9" aria-expanded="false" aria-controls="collapseNine9">
                                        <div class="program-sponcer-logo d-block">
                                            <div class="col-12 text-left">
                                              <small class="text-dark"> <?php echo e(__('land-power-by')); ?> <span class="org-txt"> <?php echo e(__('land-ora')); ?> </span></small>
                                            </div>
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/SMS Cooker logo.jpg')); ?>" class="img-fluid w-100">
                                        </div>
                                        <div class="col-12 text-center see-more-btn">
                                        <p class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i> </p>
                                        </div>
                            ...
                            <div id="collapseNine9"  class="panel-collapse collapse mt-3">
                              <div class="card-body">
                                    <div class="cardbody1">    
                                   <p class="mb-1 text-sticky">
                                           <?php echo e(__('land-smscooker')); ?>

                                        </p>
                                        <ul class="text-sticky mb-4  pl-3">
                                            <li>
                                              <?php echo e(__('land-sms')); ?> 
                                            </li>
                                            <li>
                                             <?php echo e(__('land-loc-bas')); ?> 
                                            </li>
                                            <li>
                                            <?php echo e(__('land-vip-sms')); ?>
            ...
            <div class="row">
                 <ul class="nav row w-100 p-0 justify-content-center nav-pills my-4" id="pills-tab" role="tablist">
                  <li class="nav-item w-25 text-center">
                    <a class="nav-link active" id="pills-Professional-tab" data-toggle="pill" href="#pills-Professional" role="tab" aria-controls="pills-Professional" aria-selected="true"> <?php echo e(__('land-pro-pack')); ?> </a>
                  </li>
                  <li class="nav-item w-25 text-center">
                    <a class="nav-link" id="pills-SuperProfessional-tab" data-toggle="tab" href="#pills-SuperProfessional" role="tab" aria-controls="pills-SuperProfessional" aria-selected="false"> <?php echo e(__('land-sup-pro-pack')); ?> </a>
                  </li>
                </ul>
                ...
                <div class="tab-pane fade show active" id="pills-Professional" role="tabpanel" aria-labelledby="pills-Professional-tab">
                   <div class="row images-section justify-content-center">
                     <div class="col-md-3">
                         <h3 class="img-top-text"><?php echo e(__('land-conn')); ?></h3>        
                     ...
                     <div class="col-md-3">
                      <h3 class="img-top-text"><?php echo e(__('land-hard')); ?></h3>        
                     ...
                     <div class="col-md-3">
                         <h3 class="img-top-text"><?php echo e(__('land-app')); ?></h3>   
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/Professinal package banner b2b.jpg')); ?>" class="img-fluid w-100">
                     </div> 
                    ...
                    <div class="row content-section justify-content-center">
                        <div class="col-md-3 mt-3">
                           <div class="col-12 text-center see-more-btn">
                             <a class="m-0 fs-14"><?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-down"></i></a>
                           </div>  
                        </div>
                        <div class="col-md-1"></div>
                        <div class="col-md-3 mt-3">
                           <div class="col-12 text-center see-more-btn">
                            <button class="border-0 bg-none" data-toggle="modal" data-target="#featuresModal2-prof" type="button"> <?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-right"></i></button>
                           </div> 
                    ...
                    <div id="carouselExampleControls" class="carousel slide bg-mauv" data-ride="carousel">
                      ...
                      <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
                        ...
                        <span class="sr-only"><?php echo e(__('land-previous')); ?></span>
                      </a>
                      <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        <span class="sr-only"><?php echo e(__('land-nex')); ?></span>
                      </a>
                    </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-3 mt-3">
                           <div class="col-12 text-center see-more-btn">
                            <button class="border-0 bg-none" data-toggle="modal" data-target="#featuresModal-prof" type="button"> <?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-right"></i></button>
                           </div> 
                          <div class="modal fade" id="featuresModal-prof" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('land-benefits')); ?></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>    
                            <div id="carouselExampleControls1" class="carousel slide bg-mauv" data-ride="carousel">
                              <div class="carousel-inner">
                                <div class="carousel-item active py-3">
                                   ...
                                   <?php echo e(__('land-present')); ?>
                                    ...
                                    <?php echo e(__('fam-Auto Scheduling')); ?>
                                        ...
                                        <li>
                                    <?php echo e(__('land-auto-activity')); ?>

                                        </li>
                                        <li>
                                          <?php echo e(__('land-track')); ?>
                                ...
                                <div class="carousel-item py-3">
                                 <ul class="text-sticky2 pr-5">    
                                 <li>
                                    <?php echo e(__('land-social-media')); ?>

                                </li>
                                <li>
                                    <?php echo e(__('land-unlimited-team')); ?>

                                </li>
                                <li>
                                    <?php echo e(__('land-design')); ?>

                                </li>
                                <li>
                                    <?php echo e(__('land-avaliable-storage')); ?>

                                </li>
                                <li>
                                    <?php echo e(__('land-content-right')); ?>
                                ...
                                <div class="carousel-item py-3">
                                    <ul class="text-sticky2 pr-5">
                                      <li>
                                    <?php echo e(__('fam-Reports')); ?>

                                </li>
                                <li>
                                    <?php echo e(__('land-automatic-activities')); ?> 
                                    <br>
                                    <?php echo e(__('land-responses')); ?>

                                </li>
                                <li>
                                    <?php echo e(__('land-account')); ?> 
                                    <br>
                                    <?php echo e(__('land-provide-client')); ?>

                                </li>
                                <li>
                                    <?php echo e(__('land-ad')); ?>

                                    <span class="text-red">
                                        <?php echo e(__('land-additional-add')); ?>

                                    </span>
                                    <?php echo e(__('land-other-accounts')); ?>
                                ...
                                <li>
                                    ...
                                    <?php echo e(__('land-privileges')); ?>

                                </li>
                                <li>
                                    <?php echo e(__('pay-getFreeLaptop')); ?> 
                                </li>
                                <li>
                                    <?php echo e(__('pay-internetPackages')); ?>  
                                </li>
                                <li>
                                    <?php echo e(__('land-pdone')); ?> 
                                </li>
                                <li>
                                    <?php echo e(__('land-program')); ?>
                                ...
                                <div class="carousel-item py-3">
                                <p class="mb-1 px-3 text-light">
                                 <?php echo e(__('land-platform')); ?>


                                </p>
                               <p class="mb-1 pl-3 text-light">
                                <?php echo e(__('land-done-tasks')); ?>


                                </p>
                                <ul class="text-sticky2 pr-5 mb-0">
                                    <li>
                                    <?php echo e(__('land-add')); ?>

                                    </li>
                                    <li>
                                    <?php echo e(__('land-unlimited')); ?>

                                    </li>
                                    <li>
                                     <?php echo e(__('land-storage')); ?>
                              ...
                              <a class="carousel-control-next" href="#carouselExampleControls1" role="button" data-slide="next">
                                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                <span class="sr-only"><?php echo e(__('land-next')); ?></span>
                              </a>
                            </div>
                            </div>
                            </div>
                   ...
                   <div class="router-body">
                    <div class="col-12 text-center see-more-btn packagesDropdown button dropdown">
                        <select id="pkgselector" style="background:none;color:white;border:none;" name="Go-packages" class="">
                          <option value="0"><?php echo e(__('land-choose')); ?></option>
                          <option value="Go15"> <?php echo e(__('land-bg')); ?> 15</option>
                          <option value="Go35"><?php echo e(__('land-bg')); ?>35</option>
                          <option value="Go65"><?php echo e(__('land-bg')); ?>65</option>
                          <option value="Go100"><?php echo e(__('land-bg')); ?>100</option>
                          <option value="Go150"><?php echo e(__('land-bg')); ?>150</option>
                          <option value="Go250"><?php echo e(__('land-bg')); ?>250</option>
                          <option value="Go400"><?php echo e(__('land-bg')); ?>400</option>
                        </select>
                    </div>
                     <div class="output">
                      <div id="Go15"  class="colors">
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="row mx-0">
                                    <p class="col-9 mb-0 p-0 text-left"><?php echo e(__('land-p-m')); ?></p>
                                    <p class="col-3 mb-0 p-0 text-center text-dark">15 L.E </p>      
                               
                                    <p class="col-9 mb-0 p-0 text-left"><?php echo e(__('land-ps')); ?></p>
                                    <p class="col-3 mb-0 p-0 text-center text-dark">1600	</p>    
                               
                                    <p class=" mb-0 text-left"><?php echo e(__('land-post-bundle')); ?></p>
                                     <p class=" mb-0 text-left text-dark">
                                      <?php echo e(__('land-bg')); ?> 
                                     </p>  
                                  </div>
                              </div>
                    ...
                    <div class="row mx-0 py-3 my-3 program-sponcer-section">     
                         <div class="col-md-12 text-left">
                          <p class="text-dark"><?php echo e(__('land-total-price')); ?> </p>
                        </div>
                         <div class="col-md-12 text-center">
                          <div class="col">
                            <p class="font-weight-bold mt-1 price-bg"><strong>4999
                                                 L.E <?php echo e(__('land-annually')); ?>  </strong> 
                            </p>
                         ...
                         <div class="col-md-12 text-left">
                                      <p  class="text-dark mb-0 mt-2"><?php echo e(__('land-install')); ?> <span class="font-weight-bold text-color-red">18</span> 
                                         <?php echo e(__('land-months')); ?></p>
                          </div>
                     </div> 
                 </div>  
                ...
                <div class="row">
                  <div class="col-md-12">
                    <h3 class="img-top-text"> <?php echo e(__('land-prof-package')); ?> </h3>        
                  </div>
                  <div class="col-md-6">
                    <h3 class="img-top-text"> <?php echo e(__('land-marketing')); ?>  </h3>        
 
                 </div>  
                 <div class="col-md-6">
                  <h3 class="img-top-text"> <?php echo e(__('land-effective-sales')); ?> </h3>        
                  ...
                  <div class="tab-pane fade" id="pills-SuperProfessional" role="tabpanel" aria-labelledby="pills-SuperProfessional-tab">
                    <div class="row images-section justify-content-center">
                     ...
                     <div class="col-md-1 justify-content-center d-flex align-items-center">
                      <i class="fas fa-plus-square faplus-style"></i>    
                       ...
                       <div class="col-md-3">
                         <h3 class="img-top-text"><?php echo e(__('land-app')); ?></h3>   
                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/Super Professinal banner b2b.jpg')); ?>" class="img-fluid w-100">
                     </div> 
                    ...
                    <div class="col-md-3 mt-3">
                       <div class="col-12 text-center see-more-btn">
                        <button class="border-0 bg-none" data-toggle="modal" data-target="#featuresModal2-sp" type="button"> <?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-right"></i></button>
                       </div> 
                  ...
                  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
                    ...
                    <div class="col-md-3 mt-3">
                       <div class="col-12 text-center see-more-btn">
                        <button class="border-0 bg-none" data-toggle="modal" data-target="#featuresModal-sp" type="button"> <?php echo e(__('land-see-mo')); ?> <i class="fas fa-arrow-right"></i></button>
                       </div> 
                    ...
                    <div class="row my-5 justify-content-center">
                         <div class="col-md-3">
                           <div class="router-body">
                            <div class="col-12 text-center see-more-btn packagesDropdown button dropdown">
                                <select id="pkgselector2" style="background:none;color:white;border:none;" name="Go-packages" class="">
                                  <option value="0"><?php echo e(__('land-choose')); ?></option>
                                  <option value="Go15"> <?php echo e(__('land-bg')); ?> 15</option>
                                  <option value="Go35"><?php echo e(__('land-bg')); ?>35</option>
                                  <option value="Go65"><?php echo e(__('land-bg')); ?>65</option>
 ...
 $(function() {
  /*$('#pkgselector2').change(function(){
    ...
    $('#' + $(this).val()).show();
     ...
     $('#pkgselector2').change(function(){
    $('.colors2').hide() ;// hide all
        .filter('[value="'+$(this).val()+'"]').show(); // filter options with required value
 // and show them
});
});
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('sticky.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel-Projects\StickyPost2\inc\themes\frontend\pure\views/sticky/pages/back_to_business.blade.php ENDPATH**/ ?>