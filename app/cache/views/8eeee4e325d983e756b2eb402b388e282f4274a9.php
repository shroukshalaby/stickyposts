            ...
            <div class="container">
                <div class="row justify-content-center align-items-center text-white">
                    <div class="col-md-10 col-12 no-padding">
                        <h1 class="text-white mb-md-5 mb-3 mt-5 ml-0 text-start prise-font1"><?php echo e(__('sel-h1')); ?></h1>
                    </div>
                    <div class="col-md-5 col-12 no-padding">
                        ...
                        <ul class='pl-5 a'>
                            <li>
                                <?php echo e(__('sel-ulOne')); ?>


                            </li>
                            <li>
                            <!-- <?php echo e(__('sel-ulOne')); ?> -->
                                <?php echo e(__('sel-ulTwo')); ?>


                            </li>
                            <li>
                                <?php echo e(__('sel-ulThree')); ?>
                    ...
                    <div class="col-md-5 col-12 no-padding">
                        <form class="contact-sel instructor_form_register" method="post">
                            <div class="content-title-box">
                                <div class="title pri-color1"><?php echo e(__('sel-titleForm')); ?></div>
                            </div>
                            <div class="form-row form-inputs-style">
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="validationDefaultUsername" placeholder="<?php echo e(__('sel-name')); ?>" aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="company" class="form-control" id="validationDefaultUsername" placeholder="<?php echo e(__('sel-company')); ?>"aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" class="form-control" id="validationDefaultUsername" placeholder="<?php echo e(__('sel-email')); ?>" aria-describedby="inputGroupPrepend2" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone"  class="form-control" id="validationDefaultUsername" placeholder="<?php echo e(__('sel-numberPhone')); ?>" aria-describedby="inputGroupPrepend2" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <select name="function" class="form-control">
                                            <option disabled selected><?php echo e(__('sel-jobFunction')); ?></option>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <select name="numEmps" class="form-control">
                                            <option disabled selected><?php echo e(__('sel-numberEmployes')); ?></option>
                                ...
                                <div class="col-12">
                                    <div class="text-start p-0 pri-font2"><span class="pri-span1">( <span class="pri-color2">*</span> )</span> <?php echo e(__('sel-requiredStar')); ?>

                                    </div>
                                    <label for="validationTextarea"><?php echo e(__('sel-doYouWant')); ?></label>
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="customControlValidation2"><?php echo e(__('sel-getContact')); ?></label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <input class="form-control submit" type="submit" style="" value="<?php echo e(__('dev-re')); ?>">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class='container py-5 enterprisePkSection'>
            <div class='row justify-content-center'>
                <div class='col-md-8 mb-md-0 mb-3 pri-pa1'>
                            ...
                            <div class="card pri-dire1">
                                <form>
                                    <div class="card-body box_shadow p-md-2 pt-5 pb-4">
                                        <div class="row">
                                            <div class="pri-poss1">
                                                <p class="pri-poss2"> <?php echo e(__('sel-forLimited')); ?></p>
                                            </div>
                                            <img src="<?php echo e(get_theme_frontend_url('assets/sticky/logo-s.png')); ?>" class="img-fluid IMAGES img-french">
                                            <div class="col-12 text-center">
                                                <p class="pri-poss3"><?php echo e(__('sel-get')); ?>

                                                    <span class="pri-poss4"><?php echo e(__('sel-getOffer')); ?></span>
                                                </p>
                                                <p class="pri-poss5"><?php echo e(__('sel-customizePackage')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="row related-blogs mt-md-5 mt-3 mx-0" style="">
                        <div class="col-12 px-2 mb-2">
                            <h4><?php echo e(__('sel-h4')); ?></h4>
                        </div>
                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 px-md-2 px-0 mb-md-0 mb-3">
                            <div class="boxss">
                                <a href="<?php echo e('https://stickyposts.net/blog/stickypost-en/' . $post->title_slug); ?> ">
                                    <div class="imagess">
                                        <img src=" <?php echo e('https://stickyposts.net/blog/stickypost-en/' . $post->image_mid); ?>"
                                             alt="" class="img-fluid w-100">
                                    </div>
                                    <div class="caption-content text-right px-3">
                                        <div class="text-box" data-maxlength="200" dir="LTR">
                                            <p class="text-truncate text-start">  <?php echo e($post->title); ?>  </p>
                                        </div>
                                    </div>
                                </a>
...
<?php $__env->startPush('scripts'); ?>
    <?php echo $__env->make('sticky.layout.partials.common.inboundLeadScript',['selector'=>'.instructor_form_register','type'=>'enterprise_package'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('sticky.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel-Projects\StickyPost2\inc\themes\frontend\pure\views/sticky/pages/enterprise_package.blade.php ENDPATH**/ ?>