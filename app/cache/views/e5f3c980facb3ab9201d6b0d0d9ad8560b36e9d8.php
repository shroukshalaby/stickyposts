...
<?php $__env->startSection('body'); ?>
	...
	<div id="page">
        <div class='container mt-5 '>
                ...
                <h2 class='pt-5 block-title text-center' > <?php echo e(__('thanks-idhh21')); ?> </h2> 
                <p  class=" text-center f-w-500 colo-b">  <?php echo e(__('thanks-idp1')); ?></p>
                <h5   class=" text-center  f-w-500 colo-b"><?php echo e(__('thanks-idh51')); ?></h5>
                <h5   class=" text-center  f-w-b colo-b"><?php echo e(__('thanks-idh52')); ?></h5> 
                ...
                <div class="card  text-center back-l .mar-t-15" >
                                        <div class="card-header text-center p-0">
                                            ...
                                            ?>
                                                <p class="m-0 f-s-12">  <?php echo e(__('thanks-idspan1')); ?><span class="mar-r-10">[ <?php echo $total_count ?> ]</span><!--Kholy dinamic--> </p>
                                            </div>
                ...
                <section class="mb-5 mt-4 box_shadow ">
        			<h5 class='block-title'><?php echo e(__('thanks-idh53')); ?> </h5>
        ...
        <button type="button" class="close colo-w wid-25 hei-25 flo-r"  id='closePop' data-dismiss="modal" >&times;</button>
                  ...
                  <div class="row">
                    ...
                    <button class="submit mt-2 pad-2-25 mar-t-23" data-toggle="modal" data-target="#getNow"   type="submit" id="sub"  > 
                      ...
                      <div class="col-7">
                  <h3 class='text-center colo-w'>  <?php echo e(__('thanks-idh31')); ?></h3>
                  <p class='text-center' ><?php echo e(__('thanks-idp2')); ?></p>
                  <form  method= "post" class="thanks_extra_form dir-l">
        
                                                    
                                                <div class="form-group row mb-2  mr-auto" >
                                                   <label class="col-12  text-left m-0 f-s-11">  <span class="colo-r">*</span>   <?php echo e(__('thanks-idla1')); ?>      </label>
                                                ...
                                                <div class="form-group row mb-2 mr-auto">
                                                         <label class="col-12 text-left m-0 f-s-11" >  <span class="colo-r">*</span>   <?php echo e(__('thanks-idla2')); ?>       </label>
                                                          <div class="col-12">
                                                           <select name="hear_channel"  class="form-control hei-24 f-s-12 li-hei-1 p-0"  id="">
                                                                   <option  Selected>  <?php echo e(__('thanks-idla3')); ?>    </option>
        	                                                       <option  value="friend"> <?php echo e(__('thanks-idla4')); ?>   </option>
        	                                                       <option  value="google">  <?php echo e(__('thanks-idla5')); ?>   </option>
        	                                                       <option  value="article">  <?php echo e(__('thanks-idla6')); ?>  </option>
        	                                                       <option  value="tv-ad">    <?php echo e(__('thanks-idla7')); ?> </option>
        	                                               </select>
                                                ...
                                                <p class='text-center'> <?php echo e(__('affil-idsmal1')); ?></p>
        ...
        <button type="button" class="close colo-w wid-25 hei-25 flo-l"  id='closePop' data-dismiss="modal"  name="update">&times;</button>
                ...
                <h3>  <?php echo e(__('thanks-idla9')); ?> </h3>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('sticky.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel-Projects\StickyPost2\inc\themes\frontend\pure\views/sticky/pages/thanks.blade.php ENDPATH**/ ?>