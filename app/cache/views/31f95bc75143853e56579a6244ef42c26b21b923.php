...
<div id="container">
      ...
      <div class="container <?php echo e(getCurrentLangIdiom() == 'ar' ? ' text-right'  : ''); ?>">
        <div class="row justify-content-center res-padding">

            <div class="col-md-7 my-auto view-mobile">
                <h3  class="text-start colo-w  f-s-5 li-hei-4 mt-3"><?php echo e(__('reports_h1_text')); ?></h3>
                <h3  class="text-start colo-w  f-s-5 li-hei-4 m-b-4"><?php echo e(__('reports_h2_text')); ?></h3>
                <div class="subform mt-4">
                    <a class="submit f-s-5 pad-5-15" style="<?php echo e(getCurrentLangIdiom() == 'ar' ? 'padding:0 10px'  : 'padding:10px'); ?>" href="<?php echo e(get_url('register')); ?>"> <?php echo e(__('StartTrial')); ?></a>

                </div>
                <div class="mar-t-6 f-s-9 f-w-700" >
                    <a href="<?php echo e(get_url('pricing')); ?>" id="compar" class="colo-w t-d-u" > <?php echo e(__('PackageComparison')); ?>  </a>
                </div>
            </div>
            <div class="col-lg-7 col-md-8 col-sm-7 hide-mobile text-center">
                <h3  class="colo-w f-s-5 li-hei-4 text  mt-4"><?php echo e(__('reports_h1_text')); ?></h3>
                <h3  class="text colo-w f-s-5 li-hei-4 m-b-4"><?php echo e(__('reports_h2_text')); ?></h3>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 <?php echo e(getCurrentLangIdiom() == 'fr' ? 'mt-3'  : ''); ?>">
                                        <h6 class="text-dark m-b-5" ><?php echo e(__('temp-downloads')); ?></h6>
                                        <div class="stage">
                                            <p>
                                                <a href="https://play.google.com/store/apps/details?id=com.stickyapp.myappcompany"><img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/Google play.png')); ?>" class="wid-48">
                                                </a>
                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        <div class="pos-abs lef-25 backg-r top-25 colo-w pad-1-6">
                                            <p class="m-0 f-s-14"> <?php echo e(__('for_limited')); ?></p>
                                        </div>
                                        <img src="<?php echo e(get_theme_frontend_url('assets/sticky/logo-s.png')); ?>" class="img-fluid IMAGES">
                                        <div class="col-12 text-center">

                                            <p class="promo" class="f-s-15 mar-19 li-hei-4"><?php echo e(__('h_sub_and_use')); ?>

                                            <span class="f-w-b f-s-18"><?php echo e(__('30_disc')); ?> </span> <?php echo e(__('h_promo_text')); ?></p>
                                        </div>
                                        <div class="col-12 text-start">
                                            <a class="submit" style="<?php echo e(getCurrentLangIdiom() == 'ar' ? 'padding:0 4px'  : 'padding:7px 5px'); ?>" href="<?php echo e(get_url('register')); ?>"><?php echo e(__('temp-getNow')); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="col-lg-4 col-md-4 col-sm-5  my-auto hide-mobile <?php echo e(getCurrentLangIdiom() == 'ar' ? ' text-left'  : 'text-right'); ?>" >
                 <?php switch( getCurrentLangIdiom()):
                    case ('ar'): ?>
                    <img src="<?php echo e(get_theme_frontend_url('assets/sticky/img/resourcesAR.png')); ?>" class="img-fluid img-width">
                    <?php break; ?>
                    <?php case ('en'): ?>
                          <img src="<?php echo e(get_theme_frontend_url('assets/sticky/img/resc.png')); ?>" class="img-fluid img-width">
                    <?php break; ?>
                    <?php case ('fr'): ?>
                           <img src="<?php echo e(get_theme_frontend_url('assets/sticky/img/resc.png')); ?>" class="img-fluid img-width">
                    <?php break; ?>
    ...
    <?php echo file_get_contents('http://127.0.0.1:8001/resource/2/' .getCurrentLangIdiom()); ?>
        ...
        <div class="modal-dialog miniDialog" >
            <div class="modal-content back-l  colo-w">
                <div class="modal-header p-1">
                    <img src="<?php echo e(get_theme_frontend_url('assets/sticky/images/logo-s.png')); ?>" class='wid-54 z-in-10'>
                ...
                <div id="modal-body">
                    <h3  class='text-center mt-3 colo-w'> <?php echo e(__('temp-h3')); ?>  <span class="colo-y f-w-b" ><?php echo e(__('temp-h3Free')); ?> </span></h3>
                    <div class="row my-row">
                        <div class="col-sm-7">
                            <div class="page-links nav nav-pills mb-4" id="pills-tab" role="tablist">
                                <a id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true" class="ml-auto mr-3 model-tabs active"><?php echo e(__('temp-login')); ?></a>

                                <a id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false" class='mr-3 model-tabs ' ><?php echo e(__('temp-register')); ?></a>
                            </div>
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <form id="form_pop1" class="dir-l" method= "post" class="login">
                                        ...
                                        <div class="form-group row mb-1 ml-auto" class="alig-it;" >
                                            <label class="col-4 px-1" class="m-0 f-s-12">  <span class="colo-r">*</span><?php echo e(__('temp-email')); ?></label>
                                            <div class="col-8 px-1">
                                                <input type="email" class="form-control hei-24" name="mail"   required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1 ml-auto alig-it"  >
                                            <label class="col-4 px-1 m-0 f-s-12" >  <span class="colo-r">*</span><?php echo e(__('temp-password')); ?></label>
                                            <div class="col-8 px-1">
                                        ...
                                        <div class="form-group row mb-1 mx-0 alig-it just-cont-c" >
                                            <div class="col-12 px-4">
                                                <a href="<?php echo e(get_url('forget_password')); ?>" class="colo-w t-d-u"><?php echo e(__('temp-forgetPassword')); ?></a>
                                            </div>
                                        </div>
                                ...
                                <form id="form_pop2"  method="post" class="formres dir-l">
                                    ...
                                    <div class="form-group row mx-0 alig-it just-cont-c" >
                                        <div class="col-4 px-1">
                                            <label class="m-0 f-s-12">  <span class="colo-r">*</span><?php echo e(__('temp-firstName')); ?></label>
                                        </div>
                                        <div class="col-8 px-1">
                                    ...
                                    <div class="form-group row mx-0 alig-it just-cont-c" >
                                        <div class="col-4 px-1">
                                            <label class="m-0 f-s-12">  <span class="colo-r">*</span><?php echo e(__('temp-lastName')); ?></label>
                                        </div>
                                        <div class="col-8 px-1">
                                    ...
                                    <div class="form-group row mx-0 alig-it just-cont-c" >
                                        <div class="col-4 px-1">
                                            <label class="m-0 f-s-12">  <span class="colo-r">*</span><?php echo e(__('temp-email')); ?></label>
                                        </div>
                                        <div class="col-8 px-1">
                                    ...
                                    <div class="form-group row mx-0 alig-it just-cont-c">
                                        <div class="col-4 px-1">
                                            <label class="m-0 f-s-12">  <span class="colo-r">*</span> <?php echo e(__('temp-password')); ?>         </label>
                                        </div>
                                        <div class="col-8 px-1">
                                    ...
                                    <div class="form-group row mx-0 alig-it just-cont-c" >
                                        <div class="col-4 px-1">
                                            <label class="m-0 f-s-10"> <span class="colo-r">*</span><?php echo e(__('temp-ConfirmPass')); ?></label>
                                        </div>
                                        <div class="col-8 px-1">
                                    ...
                                    <div class="form-group row mx-0">
                                        <div class="col-4 px-1">
                                            <label class="m-0 f-s-12" for=""><span class="colo-r">*</span> <?php echo e(__('repo-Country')); ?></label>
                                        </div>
                                    ...
                                    <div class="form-group text-center">
                                        <button class="submit mt-2" type="submit" class="f-s-2 f-w-600 bor-r-5 pad-2-10 backg-y colo-b bor-n" name="submit" id="sub"><?php echo e(__('DownloadNow')); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="dis-f just-cont-s" >
                    <small class='text-start' class="f-s-10 mar-l-15">* <?php echo e(__('gen-safe')); ?></small>
                    <small class='text-end' class="f-s-10 mar-r-15"><span class="colo-r">*</span> <?php echo e(__('gen-req')); ?></small>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog wid-480" role="document" >
            <div class="modal-content wid-480 backg-l colo-w " >
                ...
                <span class='input-group-btn'>
                    <a class='DownloadPDF btn btn-primary colo-w-i' res-id=''  href='' download> <?php echo e(__('DownloadNow')); ?> </a>
                </span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('sticky.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel-Projects\StickyPost2\inc\themes\frontend\pure\views/sticky/pages/reports.blade.php ENDPATH**/ ?>