...
CREATE TABLE `sp_users`  (
  ...
  `ids` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `pid` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `role` int(11) NULL DEFAULT NULL,
  `fullname` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `email` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `password` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `package` int(11) NULL DEFAULT NULL,
  `expiration_date` date NULL DEFAULT NULL,
  `timezone` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `login_type` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
